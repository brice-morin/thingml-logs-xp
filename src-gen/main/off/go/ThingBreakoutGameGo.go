...
func (state *ThingBreakoutGameGo) log(logMem bool) {
	var params string = "" + ("logMem=" + (fmt.Sprintf("%t", logMem) + ","))
	...
	if state.counter == 0 || logMem {
		...
		if state.lastTimestamp == 0 {
			ts = 0
			var old_lastTimestamp_32 string = "" + fmt.Sprintf("%d", int64(state.lastTimestamp))
			state.lastTimestamp = state.timestamp()
			var new_lastTimestamp_32 string = "" + fmt.Sprintf("%d", int64(state.lastTimestamp))
			state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
				Inst: state.DEBUG_ID,
				Prop_name: "lastTimestamp",
				Ty: "UInt32",
				Old_value: old_lastTimestamp_32,
				New_value: new_lastTimestamp_32,
			})
		} else {
			var t uint32 = state.timestamp()
			ts = t - state.lastTimestamp
			var old_lastTimestamp_33 string = "" + fmt.Sprintf("%d", int64(state.lastTimestamp))
			state.lastTimestamp = t
			var new_lastTimestamp_33 string = "" + fmt.Sprintf("%d", int64(state.lastTimestamp))
			state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
				Inst: state.DEBUG_ID,
				Prop_name: "lastTimestamp",
				Ty: "UInt32",
				Old_value: old_lastTimestamp_33,
				New_value: new_lastTimestamp_33,
			})
		}
		log.Println(""+("ts:")+fmt.Sprintf("%d", int64(ts))+(",lives:")+fmt.Sprintf("%d", int64(state.lives))+(",score:")+fmt.Sprintf("%d", int64(state.score))+(",level:")+fmt.Sprintf("%d", int64(state.level))+(",bx:")+fmt.Sprintf("%d", int64(state.bx))+(",by:")+fmt.Sprintf("%d", int64(state.by))+(",padx:")+fmt.Sprintf("%d", int64(state.padx)))
		log.Println(""+("#usedMem:")+fmt.Sprintf("%d", int64(state.usedMemory())))
	}
	var old_counter_8 string = "" + fmt.Sprintf("%d", int64(state.counter))
	state.counter++
	var new_counter_8 string = "" + fmt.Sprintf("%d", int64(state.counter))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "counter",
		Ty: "UInt8",
		Old_value: old_counter_8,
		New_value: new_counter_8,
	})
	if state.counter == 33 {
		var old_counter_9 string = "" + fmt.Sprintf("%d", int64(state.counter))
		state.counter = 0
		var new_counter_9 string = "" + fmt.Sprintf("%d", int64(state.counter))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "counter",
			Ty: "UInt8",
			Old_value: old_counter_9,
			New_value: new_counter_9,
		})
	}
}
...
func (state *ThingBreakoutGameGo) resetBall() {
	...
	var old_bx_21 string = "" + fmt.Sprintf("%d", int64(state.bx))
	state.bx = state.padx - state.br / state.SCALE
	var new_bx_21 string = "" + fmt.Sprintf("%d", int64(state.bx))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "bx",
		Ty: "Int16",
	...
	var old_by_27 string = "" + fmt.Sprintf("%d", int64(state.by))
	state.by = state.pady - state.br / state.SCALE
	var new_by_27 string = "" + fmt.Sprintf("%d", int64(state.by))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "by",
		Ty: "Int16",
	...
	var old_dx_17 string = "" + fmt.Sprintf("%d", int64(state.dx))
	state.dx = (state.padx + state.prevBX + state.prevBY) % 300 - 150
	var new_dx_17 string = "" + fmt.Sprintf("%d", int64(state.dx))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "dx",
		Ty: "Int16",
	...
	if state.dy > 0 {
		var old_dy_0 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.dy =  -(state.dy)
		var new_dy_0 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "dy",
			Ty: "Int16",
	...
	var old_prevBX_12 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.prevBX =  -(1)
	var new_prevBX_12 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBX",
		Ty: "Int16",
		Old_value: old_prevBX_12,
		New_value: new_prevBX_12,
	})
	var old_prevBY_5 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.prevBY =  -(1)
	var new_prevBY_5 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBY",
		Ty: "Int16",
		Old_value: old_prevBY_5,
		New_value: new_prevBY_5,
	})
}
func (state *ThingBreakoutGameGo) eraseBall() {
	...
	var old_prevBX_13 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.prevBX =  -(1)
	var new_prevBX_13 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBX",
		Ty: "Int16",
		Old_value: old_prevBX_13,
		New_value: new_prevBX_13,
	})
	var old_prevBY_6 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.prevBY =  -(1)
	var new_prevBY_6 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBY",
		Ty: "Int16",
		Old_value: old_prevBY_6,
		New_value: new_prevBY_6,
	})
}
func (state *ThingBreakoutGameGo) drawBall() {
	...
	var bs int16 = (state.br * 2) / state.SCALE
	state.eraseBall()
	var old_prevBX_14 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.prevBX = (state.bx - state.br) / state.SCALE
	var new_prevBX_14 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBX",
		Ty: "Int16",
		Old_value: old_prevBX_14,
		New_value: new_prevBX_14,
	})
	var old_prevBY_7 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.prevBY = (state.by - state.br) / state.SCALE
	var new_prevBY_7 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBY",
		Ty: "Int16",
		Old_value: old_prevBY_7,
		New_value: new_prevBY_7,
	})
	var r_17 uint8 = 183
	var g_18 uint8 = 199
	var b_19 uint8 = 111
...
func (state *ThingBreakoutGameGo) drawPad() {
	...
	var ps int16 = state.padlen / state.SCALE
	state.erasePad()
	var old_prevPX_38 string = "" + fmt.Sprintf("%d", int64(state.prevPX))
	state.prevPX = (state.padx - (state.padlen / 2)) / state.SCALE
	var new_prevPX_38 string = "" + fmt.Sprintf("%d", int64(state.prevPX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevPX",
		Ty: "Int16",
		Old_value: old_prevPX_38,
		New_value: new_prevPX_38,
	})
	var old_prevPY_31 string = "" + fmt.Sprintf("%d", int64(state.prevPY))
	state.prevPY = state.pady / state.SCALE
	var new_prevPY_31 string = "" + fmt.Sprintf("%d", int64(state.prevPY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevPY",
		Ty: "Int16",
		Old_value: old_prevPY_31,
		New_value: new_prevPY_31,
	})
...
func (state *ThingBreakoutGameGo) incrementScore(diff int8) {
	...
	if state.score < 0 {
		var old_score_11 string = "" + fmt.Sprintf("%d", int64(state.score))
		state.score = 0
		var new_score_11 string = "" + fmt.Sprintf("%d", int64(state.score))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "score",
			Ty: "Int16",
			Old_value: old_score_11,
			New_value: new_score_11,
		})
	}
	state.drawScore()
}
	...
	case FragmentControllerMsgsMsgposition:
		if e := typedMessage; port == BreakoutGameGo_BreakoutGame_controller {
			return true, true, state, func() {
				...
				center = center / 200
				var old_padx_16 string = "" + fmt.Sprintf("%d", int64(state.padx))
				state.padx = int16((int32(state.LEFT) + center + (int32(state.RIGHT) - int32(state.LEFT)) / 2))
				var new_padx_16 string = "" + fmt.Sprintf("%d", int64(state.padx))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "padx",
					Ty: "Int16",
					Old_value: old_padx_16,
					New_value: new_padx_16,
				})
			}
		}
...
func (state *FragmentBreakoutGameStateChartSCStateINIT) OnEntry() {
	var old_startTime_36 string = "" + fmt.Sprintf("%d", int64(state.startTime))
	state.startTime = state.timestamp()
	var new_startTime_36 string = "" + fmt.Sprintf("%d", int64(state.startTime))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "startTime",
		Ty: "UInt32",
		Old_value: old_startTime_36,
		New_value: new_startTime_36,
	})
...
func (state *FragmentBreakoutGameStateChartSCStateLAUNCH) OnEntry() {
	...
	var old_countdown_25 string = "" + fmt.Sprintf("%d", int64(state.countdown))
	state.countdown = 3
	var new_countdown_25 string = "" + fmt.Sprintf("%d", int64(state.countdown))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "countdown",
		Ty: "UInt8",
		Old_value: old_countdown_25,
		New_value: new_countdown_25,
	})
	state.drawScore()
	state.drawLives()
	...
	case FragmentTimerMsgsMsgtimer_timeout:
		if t := typedMessage; port == BreakoutGameGo_BreakoutGame_clock && (t.Id == 0 && state.countdown > 0) {
			return true, true, state, func() {
				...
				var old_countdown_26 string = "" + fmt.Sprintf("%d", int64(state.countdown))
				state.countdown = state.countdown - 1
				var new_countdown_26 string = "" + fmt.Sprintf("%d", int64(state.countdown))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "countdown",
					Ty: "UInt8",
					Old_value: old_countdown_26,
					New_value: new_countdown_26,
				})
				state.Send(BreakoutGameGo_BreakoutGame_display, FragmentDisplayMsgsMsgupdate{})
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgmessage_sent{
					Inst: state.DEBUG_ID,
	...
	case FragmentTimerMsgsMsgtimer_timeout:
		if t := typedMessage; port == BreakoutGameGo_BreakoutGame_clock && (t.Id == 0) {
			return true, true, state, func() {
				...
				var old_bx_22 string = "" + fmt.Sprintf("%d", int64(state.bx))
				state.bx = state.bx + state.dx
				var new_bx_22 string = "" + fmt.Sprintf("%d", int64(state.bx))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "bx",
					Ty: "Int16",
				...
				var old_by_28 string = "" + fmt.Sprintf("%d", int64(state.by))
				state.by = state.by + state.dy
				var new_by_28 string = "" + fmt.Sprintf("%d", int64(state.by))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "by",
					Ty: "Int16",
				...
				if state.bx < wl {
					var old_dx_18 string = "" + fmt.Sprintf("%d", int64(state.dx))
					state.dx =  -(state.dx)
					var new_dx_18 string = "" + fmt.Sprintf("%d", int64(state.dx))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "dx",
						Ty: "Int16",
					...
					var old_bx_23 string = "" + fmt.Sprintf("%d", int64(state.bx))
					state.bx = 2 * wl - state.bx
					var new_bx_23 string = "" + fmt.Sprintf("%d", int64(state.bx))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "bx",
						Ty: "Int16",
					...
					if state.bx > wr {
						var old_dx_19 string = "" + fmt.Sprintf("%d", int64(state.dx))
						state.dx =  -(state.dx)
						var new_dx_19 string = "" + fmt.Sprintf("%d", int64(state.dx))
						state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
							Inst: state.DEBUG_ID,
							Prop_name: "dx",
							Ty: "Int16",
						...
						var old_bx_24 string = "" + fmt.Sprintf("%d", int64(state.bx))
						state.bx = 2 * wr - state.bx
						var new_bx_24 string = "" + fmt.Sprintf("%d", int64(state.bx))
						state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
							Inst: state.DEBUG_ID,
							Prop_name: "bx",
							Ty: "Int16",
				...
				if state.by < wt {
					var old_dy_1 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.dy =  -(state.dy)
					var new_dy_1 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "dy",
						Ty: "Int16",
					...
					var old_by_29 string = "" + fmt.Sprintf("%d", int64(state.by))
					state.by = 2 * wt - state.by
					var new_by_29 string = "" + fmt.Sprintf("%d", int64(state.by))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "by",
						Ty: "Int16",
				...
				if state.dy > 0 {
					if state.by > state.pady - state.br && state.by < state.pady + state.br {
						if state.bx > state.padx - state.padlen / 2 && state.bx < state.padx + state.padlen / 2 {
							var old_dy_2 string = "" + fmt.Sprintf("%d", int64(state.dy))
							state.dy =  -(state.dy)
							var new_dy_2 string = "" + fmt.Sprintf("%d", int64(state.dy))
							state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
								Inst: state.DEBUG_ID,
								Prop_name: "dy",
								Ty: "Int16",
							...
							var old_by_30 string = "" + fmt.Sprintf("%d", int64(state.by))
							state.by = 2 * (state.pady - state.br) - state.by
							var new_by_30 string = "" + fmt.Sprintf("%d", int64(state.by))
							state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
								Inst: state.DEBUG_ID,
								Prop_name: "by",
								Ty: "Int16",
							...
							var old_dx_20 string = "" + fmt.Sprintf("%d", int64(state.dx))
							state.dx = state.dx / 4 + (state.bx - state.padx) / 4
							var new_dx_20 string = "" + fmt.Sprintf("%d", int64(state.dx))
							state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
								Inst: state.DEBUG_ID,
								Prop_name: "dx",
								Ty: "Int16",
				...
				if collision {
					var old_dy_3 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.dy =  -(state.dy)
					var new_dy_3 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "dy",
						Ty: "Int16",
...
func (state *FragmentBreakoutGameStateChartSCStateLOSTBALL) OnEntry() {
	...
	var old_lives_35 string = "" + fmt.Sprintf("%d", int64(state.lives))
	state.lives = state.lives - 1
	var new_lives_35 string = "" + fmt.Sprintf("%d", int64(state.lives))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "lives",
		Ty: "UInt8",
		Old_value: old_lives_35,
		New_value: new_lives_35,
	})
	state.eraseBall()
	state.erasePad()
	state.drawLives()
...
func (state *FragmentBreakoutGameStateChartSCStateNEXTLEVEL) OnEntry() {
	...
	var old_level_37 string = "" + fmt.Sprintf("%d", int64(state.level))
	state.level = state.level + 1
	var new_level_37 string = "" + fmt.Sprintf("%d", int64(state.level))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "level",
		Ty: "UInt8",
		Old_value: old_level_37,
		New_value: new_level_37,
	})
	state.drawLevel()
	state.eraseBall()
	state.erasePad()
	if (state.level % 2) == 0 && state.padlen > 5 * state.SCALE {
		var old_padlen_34 string = "" + fmt.Sprintf("%d", int64(state.padlen))
		state.padlen = state.padlen - (4 * state.SCALE)
		var new_padlen_34 string = "" + fmt.Sprintf("%d", int64(state.padlen))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "padlen",
			Ty: "Int16",
			Old_value: old_padlen_34,
			New_value: new_padlen_34,
		})
	}
	if (state.level % 2) == 1 {
		var old_dy_4 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.dy = (state.dy * 3) / 2
		var new_dy_4 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "dy",
			Ty: "Int16",
...
func (state *FragmentBreakoutGameStateChartSCStateGAMEOVER) OnEntry() {
	...
	state.log(true)
	var old_stopTime_15 string = "" + fmt.Sprintf("%d", int64(state.stopTime))
	state.stopTime = state.timestamp()
	var new_stopTime_15 string = "" + fmt.Sprintf("%d", int64(state.stopTime))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "stopTime",
		Ty: "UInt32",
		Old_value: old_stopTime_15,
		New_value: new_stopTime_15,
	})
	state.quit()
}
