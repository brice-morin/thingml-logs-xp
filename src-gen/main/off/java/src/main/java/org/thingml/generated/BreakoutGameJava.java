...
Transition h1111173986 = new Transition();
h1111173986.from(state_BreakoutGame_SC_INIT).to(state_BreakoutGame_SC_LAUNCH);
h1111173986.event(displayReadyType);
h1111173986.port(display_port);
h1111173986.action((Event e)->{
...
Handler h759564454 = new Handler();
h759564454.from(state_BreakoutGame_SC_LAUNCH);
h759564454.event(timer_timeoutType);
h759564454.guard((Event e)->{
...
h759564454.port(clock_port);
h759564454.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
...
Transition h502386384 = new Transition();
h502386384.from(state_BreakoutGame_SC_LAUNCH).to(state_BreakoutGame_SC_PLAY);
h502386384.event(timer_timeoutType);
h502386384.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_SC_LAUNCH_countdown_var() == 0;
});

h502386384.port(clock_port);
h502386384.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Handler h982073480 = new Handler();
h982073480.from(state_BreakoutGame_SC_PLAY);
h982073480.event(timer_timeoutType);
h982073480.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h982073480.port(clock_port);
h982073480.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Transition h543028700 = new Transition();
h543028700.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h543028700.event(lostBallType);
h543028700.port(game_port);
h543028700.action((Event e)->{
...
Transition h190702991 = new Transition();
h190702991.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h190702991.event(nextLevelType);
h190702991.port(game_port);
h190702991.action((Event e)->{
...
Transition h1465663131 = new Transition();
h1465663131.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h1465663131.event(lostBallType);
h1465663131.port(pro_game_port);
h1465663131.action((Event e)->{
...
Transition h786728464 = new Transition();
h786728464.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h786728464.event(nextLevelType);
h786728464.port(pro_game_port);
h786728464.action((Event e)->{
...
Transition h4573619 = new Transition();
h4573619.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_LAUNCH);
h4573619.event(timer_timeoutType);
h4573619.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() > 0;
});

h4573619.port(clock_port);
h4573619.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Transition h532613259 = new Transition();
h532613259.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_GAMEOVER);
h532613259.event(timer_timeoutType);
h532613259.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() == 0;
});

h532613259.port(clock_port);
h532613259.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Transition h1447678234 = new Transition();
h1447678234.from(state_BreakoutGame_SC_NEXTLEVEL).to(state_BreakoutGame_SC_LAUNCH);
h1447678234.event(timer_timeoutType);
h1447678234.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h1447678234.port(clock_port);
h1447678234.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Handler h1755634886 = new Handler();
h1755634886.from(state_BreakoutGame_SC);
h1755634886.event(positionType);
h1755634886.port(controller_port);
h1755634886.action((Event e)->{
...
Handler h358847552 = new Handler();
h358847552.from(state_BreakoutGame_SC);
h358847552.event(timer_timeoutType);
h358847552.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return true;
});

h358847552.port(clock_port);
h358847552.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Handler h1242969461 = new Handler();
h1242969461.from(state_BreakoutGame_SC);
h1242969461.event(displayReadyType);
h1242969461.guard((Event e)->{
return true;
});

h1242969461.port(display_port);
h1242969461.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("display"), (String) ("displayReady"), (String) (""));
});

Handler h1128600792 = new Handler();
h1128600792.from(state_BreakoutGame_SC);
h1128600792.event(lostBallType);
h1128600792.guard((Event e)->{
return true;
});

h1128600792.port(game_port);
h1128600792.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("game"), (String) ("lostBall"), (String) (""));
});

Handler h1119371910 = new Handler();
h1119371910.from(state_BreakoutGame_SC);
h1119371910.event(nextLevelType);
h1119371910.guard((Event e)->{
return true;
});

h1119371910.port(game_port);
h1119371910.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("game"), (String) ("nextLevel"), (String) (""));
});

Handler h1928983164 = new Handler();
h1928983164.from(state_BreakoutGame_SC);
h1928983164.event(lostBallType);
h1928983164.guard((Event e)->{
return true;
});

h1928983164.port(pro_game_port);
h1928983164.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("pro_game"), (String) ("lostBall"), (String) (""));
});

Handler h1778257620 = new Handler();
h1778257620.from(state_BreakoutGame_SC);
h1778257620.event(nextLevelType);
h1778257620.guard((Event e)->{
return true;
});

h1778257620.port(pro_game_port);
h1778257620.action((Event e)->{
