...
Transition h898810308 = new Transition();
h898810308.from(state_BasicIAController_SC_Following).to(state_BasicIAController_SC_Following);
h898810308.event(updateIAType);
h898810308.port(game_port);
h898810308.action((Event e)->{
