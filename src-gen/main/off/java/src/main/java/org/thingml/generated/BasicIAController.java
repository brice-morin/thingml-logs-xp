...
Transition h1493657028 = new Transition();
h1493657028.from(state_BasicIAController_SC_Following).to(state_BasicIAController_SC_Following);
h1493657028.event(updateIAType);
h1493657028.port(game_port);
h1493657028.action((Event e)->{
