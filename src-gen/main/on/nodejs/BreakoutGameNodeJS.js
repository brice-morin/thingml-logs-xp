...
BreakoutGameNodeJS.prototype.build = function(session) {
	...
	let BreakoutGame_SC_INIT = new StateJS.State('INIT', this._statemachine).entry(() => {
		const old_startTime_5_var = '' + this.BreakoutGame_startTime_var;
		this.BreakoutGame_startTime_var = this.timestamp();
		const new_startTime_5_var = '' + this.BreakoutGame_startTime_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'startTime', 'UInt32', old_startTime_5_var, new_startTime_5_var));
		const xsize_172_var = this.BreakoutGame_XDISPSIZE_var;
		const ysize_173_var = this.BreakoutGame_YDISPSIZE_var;
		this.bus.emit('display', new Event.Create('display', xsize_172_var, ysize_173_var));
		const params_174_var = '' + ('xsize=' + (xsize_172_var + ',')) + ('ysize=' + (ysize_173_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'create', params_174_var));
	});
	let BreakoutGame_SC_LAUNCH = new StateJS.State('LAUNCH', this._statemachine).entry(() => {
		...
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_start('clock', id_193_var, time_194_var))});
		const params_195_var = '' + ('id=' + (id_193_var + ',')) + ('time=' + (time_194_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_start', params_195_var));
		const old_countdown_13_var = '' + this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = 3;
		const new_countdown_13_var = '' + this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'countdown', 'UInt8', old_countdown_13_var, new_countdown_13_var));
		this.drawScore();
		this.drawLives();
		this.bus.emit('display', new Event.Update('display'));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'update', ''));
	});
	let BreakoutGame_SC_PLAY = new StateJS.State('PLAY', this._statemachine).entry(() => {
		const id_199_var = 0;
		const time_200_var = this.BreakoutGame_period_var;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_start('clock', id_199_var, time_200_var))});
		const params_201_var = '' + ('id=' + (id_199_var + ',')) + ('time=' + (time_200_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_start', params_201_var));
	});
	let BreakoutGame_SC_LOSTBALL = new StateJS.State('LOSTBALL', this._statemachine).entry(() => {
		...
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_start('clock', id_218_var, time_219_var))});
		const params_220_var = '' + ('id=' + (id_218_var + ',')) + ('time=' + (time_219_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_start', params_220_var));
		const old_lives_19_var = '' + this.BreakoutGame_lives_var;
		this.BreakoutGame_lives_var = this.BreakoutGame_lives_var - 1;
		const new_lives_19_var = '' + this.BreakoutGame_lives_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'lives', 'UInt8', old_lives_19_var, new_lives_19_var));
		this.eraseBall();
		this.erasePad();
		this.drawLives();
		this.bus.emit('display', new Event.Update('display'));
	...
	let BreakoutGame_SC_NEXTLEVEL = new StateJS.State('NEXTLEVEL', this._statemachine).entry(() => {
		...
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_start('clock', id_221_var, time_222_var))});
		const params_223_var = '' + ('id=' + (id_221_var + ',')) + ('time=' + (time_222_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_start', params_223_var));
		const old_level_29_var = '' + this.BreakoutGame_level_var;
		this.BreakoutGame_level_var = this.BreakoutGame_level_var + 1;
		const new_level_29_var = '' + this.BreakoutGame_level_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'level', 'UInt8', old_level_29_var, new_level_29_var));
		this.drawLevel();
		this.eraseBall();
		this.erasePad();
		if((this.BreakoutGame_level_var % 2) === 0 && this.BreakoutGame_padlen_var > 5 * this.BreakoutGame_SCALE_var) {
		const old_padlen_4_var = '' + this.BreakoutGame_padlen_var;
		this.BreakoutGame_padlen_var = this.BreakoutGame_padlen_var - (4 * this.BreakoutGame_SCALE_var);
		const new_padlen_4_var = '' + this.BreakoutGame_padlen_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'padlen', 'Int16', old_padlen_4_var, new_padlen_4_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_25_var, new_dy_25_var));
	...
	let BreakoutGame_SC_GAMEOVER = new StateJS.State('GAMEOVER', this._statemachine).entry(() => {
		...
		const g_225_var = 255;
		const b_226_var = 255;
		this.bus.emit('display', new Event.SetColor('display', r_224_var, g_225_var, b_226_var));
		const params_227_var = '' + ('r=' + (r_224_var + ',')) + ('g=' + (g_225_var + ',')) + ('b=' + (b_226_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_227_var));
		const x_228_var = 8;
		const y_229_var = 30;
		const width_230_var = 142;
		const height_231_var = 76;
		this.bus.emit('display', new Event.FillRect('display', x_228_var, y_229_var, width_230_var, height_231_var));
		const params_232_var = '' + ('x=' + (x_228_var + ',')) + ('y=' + (y_229_var + ',')) + ('width=' + (width_230_var + ',')) + ('height=' + (height_231_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_232_var));
		...
		;
		this.bus.emit('display', new Event.SetColor('display', r_233_var, g_234_var, b_235_var));
		const params_236_var = '' + ('r=' + (r_233_var + ',')) + ('g=' + (g_234_var + ',')) + ('b=' + (b_235_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_236_var));
		const x_237_var = 9;
		const y_238_var = 31;
		const width_239_var = 140;
		const height_240_var = 50;
		this.bus.emit('display', new Event.FillRect('display', x_237_var, y_238_var, width_239_var, height_240_var));
		const params_241_var = '' + ('x=' + (x_237_var + ',')) + ('y=' + (y_238_var + ',')) + ('width=' + (width_239_var + ',')) + ('height=' + (height_240_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_241_var));
		...
		;
		this.bus.emit('display', new Event.SetBGColor('display', r_242_var, g_243_var, b_244_var));
		const params_245_var = '' + ('r=' + (r_242_var + ',')) + ('g=' + (g_243_var + ',')) + ('b=' + (b_244_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setBGColor', params_245_var));
		const r_246_var = 158;
		const g_247_var = 209;
		const b_248_var = 130;
		this.bus.emit('display', new Event.SetColor('display', r_246_var, g_247_var, b_248_var));
		const params_249_var = '' + ('r=' + (r_246_var + ',')) + ('g=' + (g_247_var + ',')) + ('b=' + (b_248_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_249_var));
		const x_250_var = 23;
		const y_251_var = 40;
		const v_252_var = this.BreakoutGame_score_var;
		const digits_253_var = 5;
		const scale_254_var = 6;
		this.bus.emit('display', new Event.DrawInteger('display', x_250_var, y_251_var, v_252_var, digits_253_var, scale_254_var));
		const params_255_var = '' + ('x=' + (x_250_var + ',')) + ('y=' + (y_251_var + ',')) + ('v=' + (v_252_var + ',')) + ('digits=' + (digits_253_var + ',')) + ('scale=' + (scale_254_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'drawInteger', params_255_var));
		const x_256_var = 26;
		const y_257_var = 87;
		this.bus.emit('display', new Event.DrawThingML('display', x_256_var, y_257_var));
		const params_258_var = '' + ('x=' + (x_256_var + ',')) + ('y=' + (y_257_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'drawThingML', params_258_var));
		this.bus.emit('display', new Event.Update('display'));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'update', ''));
		this.log(true);
		const old_stopTime_20_var = '' + this.BreakoutGame_stopTime_var;
		this.BreakoutGame_stopTime_var = this.timestamp();
		const new_stopTime_20_var = '' + this.BreakoutGame_stopTime_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'stopTime', 'UInt32', old_stopTime_20_var, new_stopTime_20_var));
		this.quit();
	...
	this._statemachine.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		this.bus.emit('log', new Event.Message_lost('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_timeout', params_var));
	});
	BreakoutGame_SC_NEXTLEVEL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const params_var = '' + ('id=' + (timer_timeout.id + ','));
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.NEXTLEVEL', 'SC.LAUNCH', 'clock', 'timer_timeout', params_var));
	});
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const params_var = '' + ('id=' + (timer_timeout.id + ','));
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.LOSTBALL', 'SC.LAUNCH', 'clock', 'timer_timeout', params_var));
	});
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_GAMEOVER).on(Event.Timer_timeout).when((timer_timeout) => {
		return timer_timeout.port === 'clock' && timer_timeout.type === 'timer_timeout' && (timer_timeout.id === 0 && this.BreakoutGame_lives_var === 0);
	}).effect((timer_timeout) => {
		const params_var = '' + ('id=' + (timer_timeout.id + ','));
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.LOSTBALL', 'SC.GAMEOVER', 'clock', 'timer_timeout', params_var));
	});
	BreakoutGame_SC_LAUNCH.to(BreakoutGame_SC_PLAY).on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const params_var = '' + ('id=' + (timer_timeout.id + ','));
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.LAUNCH', 'SC.PLAY', 'clock', 'timer_timeout', params_var));
	...
	BreakoutGame_SC_LAUNCH.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const params_var = '' + ('id=' + (timer_timeout.id + ','));
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.LAUNCH', '_', 'clock', 'timer_timeout', params_var));
		const id_196_var = 0;
		const time_197_var = this.BreakoutGame_period_var;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_start('clock', id_196_var, time_197_var))});
		const params_198_var = '' + ('id=' + (id_196_var + ',')) + ('time=' + (time_197_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_start', params_198_var));
		this.drawPad();
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'countdown', 'UInt8', old_countdown_14_var, new_countdown_14_var));
		this.bus.emit('display', new Event.Update('display'));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'update', ''));
	});
	BreakoutGame_SC_PLAY.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const params_var = '' + ('id=' + (timer_timeout.id + ','));
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.PLAY', '_', 'clock', 'timer_timeout', params_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_16_var, new_bx_16_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'by', 'Int16', old_by_1_var, new_by_1_var));
		...
		const old_dx_7_var = '' + this.BreakoutGame_dx_var;
		this.BreakoutGame_dx_var =  -this.BreakoutGame_dx_var;
		const new_dx_7_var = '' + this.BreakoutGame_dx_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_7_var, new_dx_7_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_17_var, new_bx_17_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_8_var, new_dx_8_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_18_var, new_bx_18_var));
		this.incrementScore( -1);
		...
		const new_dy_22_var = '' + this.BreakoutGame_dy_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_22_var, new_dy_22_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'by', 'Int16', old_by_2_var, new_by_2_var));
		this.incrementScore( -1);
		
		} else {
		if(this.BreakoutGame_by_var > wb_var) {
		setImmediate(() => {this.bus.emit('game', new Event.LostBall('game'))});
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'game', 'lostBall', ''));
		setImmediate(() => {this.bus.emit('req_game', new Event.LostBall('req_game'))});
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'req_game', 'lostBall', ''));
		...
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const new_dy_23_var = '' + this.BreakoutGame_dy_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_23_var, new_dy_23_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'by', 'Int16', old_by_3_var, new_by_3_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_9_var, new_dx_9_var));
		...
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_24_var, new_dy_24_var));
		this.incrementScore(10);
		if(this.bricksLeft() === 0) {
		setImmediate(() => {this.bus.emit('game', new Event.NextLevel('game'))});
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'game', 'nextLevel', ''));
		setImmediate(() => {this.bus.emit('req_game', new Event.NextLevel('req_game'))});
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'req_game', 'nextLevel', ''));
		...
		setImmediate(() => {this.bus.emit('ia', new Event.UpdateIA('ia', ballx_202_var, bally_203_var, padx_204_var, pady_205_var))});
		const params_206_var = '' + ('ballx=' + (ballx_202_var + ',')) + ('bally=' + (bally_203_var + ',')) + ('padx=' + (padx_204_var + ',')) + ('pady=' + (pady_205_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'ia', 'updateIA', params_206_var));
		this.bus.emit('display', new Event.Update('display'));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'update', ''));
		this.log(false);
		const id_207_var = 0;
		const time_208_var = this.BreakoutGame_period_var;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_start('clock', id_207_var, time_208_var))});
		const params_209_var = '' + ('id=' + (id_207_var + ',')) + ('time=' + (time_208_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_start', params_209_var));
	});
	this._statemachine.on(Event.Position).when((position) => {
		...
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC', '_', 'controller', 'position', params_var));
		...
		const old_padx_34_var = '' + this.BreakoutGame_padx_var;
		...
		const new_padx_34_var = '' + this.BreakoutGame_padx_var;
		this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'padx', 'Int16', old_padx_34_var, new_padx_34_var));
	});
	this._statemachine.on(Event.LostBall).when((lostBall) => {
		return lostBall.port === 'game' && lostBall.type === 'lostBall' && (true);
	}).effect((lostBall) => {
		this.bus.emit('log', new Event.Message_lost('log', this.WithLog_DEBUG_ID_var, 'game', 'lostBall', ''));
	});
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_LOSTBALL).on(Event.LostBall).when((lostBall) => {
		...
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.PLAY', 'SC.LOSTBALL', 'game', 'lostBall', '_'));
		const id_210_var = 0;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_cancel('clock', id_210_var))});
		const params_211_var = '' + ('id=' + (id_210_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_cancel', params_211_var));
	});
	this._statemachine.on(Event.NextLevel).when((nextLevel) => {
		return nextLevel.port === 'game' && nextLevel.type === 'nextLevel' && (true);
	}).effect((nextLevel) => {
		this.bus.emit('log', new Event.Message_lost('log', this.WithLog_DEBUG_ID_var, 'game', 'nextLevel', ''));
	});
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_NEXTLEVEL).on(Event.NextLevel).when((nextLevel) => {
		...
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.PLAY', 'SC.NEXTLEVEL', 'game', 'nextLevel', '_'));
		const id_212_var = 0;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_cancel('clock', id_212_var))});
		const params_213_var = '' + ('id=' + (id_212_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_cancel', params_213_var));
	});
	this._statemachine.on(Event.DisplayReady).when((displayReady) => {
		...
		this.bus.emit('log', new Event.Message_lost('log', this.WithLog_DEBUG_ID_var, 'display', 'displayReady', ''));
	});
	BreakoutGame_SC_INIT.to(BreakoutGame_SC_LAUNCH).on(Event.DisplayReady).when((displayReady) => {
		...
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.INIT', 'SC.LAUNCH', 'display', 'displayReady', '_'));
		this.bus.emit('display', new Event.Clear('display'));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'clear', ''));
		this.initColors();
		...
		;
		this.bus.emit('display', new Event.SetColor('display', r_175_var, g_176_var, b_177_var));
		const params_178_var = '' + ('r=' + (r_175_var + ',')) + ('g=' + (g_176_var + ',')) + ('b=' + (b_177_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_178_var));
		const x_179_var = 0;
		const y_180_var = 0;
		const width_181_var = this.BreakoutGame_XDISPSIZE_var;
		const height_182_var = this.BreakoutGame_YDISPSIZE_var;
		this.bus.emit('display', new Event.FillRect('display', x_179_var, y_180_var, width_181_var, height_182_var));
		const params_183_var = '' + ('x=' + (x_179_var + ',')) + ('y=' + (y_180_var + ',')) + ('width=' + (width_181_var + ',')) + ('height=' + (height_182_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_183_var));
		...
		;
		this.bus.emit('display', new Event.SetColor('display', r_184_var, g_185_var, b_186_var));
		const params_187_var = '' + ('r=' + (r_184_var + ',')) + ('g=' + (g_185_var + ',')) + ('b=' + (b_186_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_187_var));
		const x_188_var = 0;
		const y_189_var = 0;
		const width_190_var = this.BreakoutGame_XDISPSIZE_var;
		const height_191_var = 14;
		this.bus.emit('display', new Event.FillRect('display', x_188_var, y_189_var, width_190_var, height_191_var));
		const params_192_var = '' + ('x=' + (x_188_var + ',')) + ('y=' + (y_189_var + ',')) + ('width=' + (width_190_var + ',')) + ('height=' + (height_191_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_192_var));
		this.drawWalls();
		this.createBricks();
		this.drawLevel();
	});
	this._statemachine.on(Event.LostBall).when((lostBall) => {
		...
		this.bus.emit('log', new Event.Message_lost('log', this.WithLog_DEBUG_ID_var, 'pro_game', 'lostBall', ''));
	});
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_LOSTBALL).on(Event.LostBall).when((lostBall) => {
		return lostBall.port === 'pro_game' && lostBall.type === 'lostBall';
	}).effect((lostBall) => {
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.PLAY', 'SC.LOSTBALL', 'pro_game', 'lostBall', '_'));
		const id_214_var = 0;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_cancel('clock', id_214_var))});
		const params_215_var = '' + ('id=' + (id_214_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_cancel', params_215_var));
	});
	this._statemachine.on(Event.NextLevel).when((nextLevel) => {
		return nextLevel.port === 'pro_game' && nextLevel.type === 'nextLevel' && (true);
	}).effect((nextLevel) => {
		this.bus.emit('log', new Event.Message_lost('log', this.WithLog_DEBUG_ID_var, 'pro_game', 'nextLevel', ''));
	});
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_NEXTLEVEL).on(Event.NextLevel).when((nextLevel) => {
		return nextLevel.port === 'pro_game' && nextLevel.type === 'nextLevel';
	}).effect((nextLevel) => {
		this.bus.emit('log', new Event.Message_handled('log', this.WithLog_DEBUG_ID_var, 'SC.PLAY', 'SC.NEXTLEVEL', 'pro_game', 'nextLevel', '_'));
		const id_216_var = 0;
		setImmediate(() => {this.bus.emit('clock', new Event.Timer_cancel('clock', id_216_var))});
		const params_217_var = '' + ('id=' + (id_216_var + ','));
		this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'clock', 'timer_cancel', params_217_var));
	});
}
BreakoutGameNodeJS.prototype.log = function(BreakoutGame_log_logMem_var) {
	const params_var = '' + ('logMem=' + (BreakoutGame_log_logMem_var + ','));
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'log', 'void_', '', params_var));
	if(this.BreakoutGame_counter_var === 0 || BreakoutGame_log_logMem_var) {
	let ts_var;
	if(this.BreakoutGame_lastTimestamp_var === 0) {
	ts_var = 0;
	const old_lastTimestamp_30_var = '' + this.BreakoutGame_lastTimestamp_var;
	this.BreakoutGame_lastTimestamp_var = this.timestamp();
	const new_lastTimestamp_30_var = '' + this.BreakoutGame_lastTimestamp_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'lastTimestamp', 'UInt32', old_lastTimestamp_30_var, new_lastTimestamp_30_var));
	
	} else {
	let t_var = this.timestamp();
	ts_var = t_var - this.BreakoutGame_lastTimestamp_var;
	const old_lastTimestamp_31_var = '' + this.BreakoutGame_lastTimestamp_var;
	this.BreakoutGame_lastTimestamp_var = t_var;
	const new_lastTimestamp_31_var = '' + this.BreakoutGame_lastTimestamp_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'lastTimestamp', 'UInt32', old_lastTimestamp_31_var, new_lastTimestamp_31_var));
	...
	const old_counter_32_var = '' + this.BreakoutGame_counter_var;
	this.BreakoutGame_counter_var++;
	const new_counter_32_var = '' + this.BreakoutGame_counter_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'counter', 'UInt8', old_counter_32_var, new_counter_32_var));
	if(this.BreakoutGame_counter_var === 33) {
	const old_counter_33_var = '' + this.BreakoutGame_counter_var;
	this.BreakoutGame_counter_var = 0;
	const new_counter_33_var = '' + this.BreakoutGame_counter_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'counter', 'UInt8', old_counter_33_var, new_counter_33_var));
	
	}
}

BreakoutGameNodeJS.prototype.initColors = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'initColors', 'void_', '', ''));
	...
	;
	this.bus.emit('display', new Event.SetBGColor('display', r_0_var, g_1_var, b_2_var));
	const params_3_var = '' + ('r=' + (r_0_var + ',')) + ('g=' + (g_1_var + ',')) + ('b=' + (b_2_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setBGColor', params_3_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_4_var, g_5_var, b_6_var));
	const params_7_var = '' + ('r=' + (r_4_var + ',')) + ('g=' + (g_5_var + ',')) + ('b=' + (b_6_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_7_var));
}

BreakoutGameNodeJS.prototype.resetBall = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'resetBall', 'void_', '', ''));
	const old_bx_15_var = '' + this.BreakoutGame_bx_var;
	this.BreakoutGame_bx_var = this.BreakoutGame_padx_var - Math.trunc(this.BreakoutGame_br_var / this.BreakoutGame_SCALE_var);
	const new_bx_15_var = '' + this.BreakoutGame_bx_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_15_var, new_bx_15_var));
	...
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'by', 'Int16', old_by_0_var, new_by_0_var));
	const old_dx_6_var = '' + this.BreakoutGame_dx_var;
	this.BreakoutGame_dx_var = (this.BreakoutGame_padx_var + this.BreakoutGame_prevBX_var + this.BreakoutGame_prevBY_var) % 300 - 150;
	const new_dx_6_var = '' + this.BreakoutGame_dx_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_6_var, new_dx_6_var));
	if(this.BreakoutGame_dy_var > 0) {
	const old_dy_21_var = '' + this.BreakoutGame_dy_var;
	this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
	const new_dy_21_var = '' + this.BreakoutGame_dy_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_21_var, new_dy_21_var));
	...
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevBX', 'Int16', old_prevBX_26_var, new_prevBX_26_var));
	const old_prevBY_10_var = '' + this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const new_prevBY_10_var = '' + this.BreakoutGame_prevBY_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevBY', 'Int16', old_prevBY_10_var, new_prevBY_10_var));
}

BreakoutGameNodeJS.prototype.eraseBall = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'eraseBall', 'void_', '', ''));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_8_var, g_9_var, b_10_var));
	const params_11_var = '' + ('r=' + (r_8_var + ',')) + ('g=' + (g_9_var + ',')) + ('b=' + (b_10_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_11_var));
	...
	this.bus.emit('display', new Event.FillRect('display', x_12_var, y_13_var, width_14_var, height_15_var));
	const params_16_var = '' + ('x=' + (x_12_var + ',')) + ('y=' + (y_13_var + ',')) + ('width=' + (width_14_var + ',')) + ('height=' + (height_15_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_16_var));
	
	}
	const old_prevBX_27_var = '' + this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const new_prevBX_27_var = '' + this.BreakoutGame_prevBX_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevBX', 'Int16', old_prevBX_27_var, new_prevBX_27_var));
	const old_prevBY_11_var = '' + this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const new_prevBY_11_var = '' + this.BreakoutGame_prevBY_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevBY', 'Int16', old_prevBY_11_var, new_prevBY_11_var));
}

BreakoutGameNodeJS.prototype.drawBall = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawBall', 'void_', '', ''));
	let bs_var = Math.trunc((this.BreakoutGame_br_var * 2) / this.BreakoutGame_SCALE_var);
	this.eraseBall();
	const old_prevBX_28_var = '' + this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var = Math.trunc((this.BreakoutGame_bx_var - this.BreakoutGame_br_var) / this.BreakoutGame_SCALE_var);
	const new_prevBX_28_var = '' + this.BreakoutGame_prevBX_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevBX', 'Int16', old_prevBX_28_var, new_prevBX_28_var));
	const old_prevBY_12_var = '' + this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var = Math.trunc((this.BreakoutGame_by_var - this.BreakoutGame_br_var) / this.BreakoutGame_SCALE_var);
	const new_prevBY_12_var = '' + this.BreakoutGame_prevBY_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevBY', 'Int16', old_prevBY_12_var, new_prevBY_12_var));
	const r_17_var = 183;
	const g_18_var = 199;
	const b_19_var = 111;
	this.bus.emit('display', new Event.SetColor('display', r_17_var, g_18_var, b_19_var));
	const params_20_var = '' + ('r=' + (r_17_var + ',')) + ('g=' + (g_18_var + ',')) + ('b=' + (b_19_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_20_var));
	...
	this.bus.emit('display', new Event.FillRect('display', x_21_var, y_22_var, width_23_var, height_24_var));
	const params_25_var = '' + ('x=' + (x_21_var + ',')) + ('y=' + (y_22_var + ',')) + ('width=' + (width_23_var + ',')) + ('height=' + (height_24_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_25_var));
}

BreakoutGameNodeJS.prototype.erasePad = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'erasePad', 'void_', '', ''));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_26_var, g_27_var, b_28_var));
	const params_29_var = '' + ('r=' + (r_26_var + ',')) + ('g=' + (g_27_var + ',')) + ('b=' + (b_28_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_29_var));
	...
	this.bus.emit('display', new Event.FillRect('display', x_30_var, y_31_var, width_32_var, height_33_var));
	const params_34_var = '' + ('x=' + (x_30_var + ',')) + ('y=' + (y_31_var + ',')) + ('width=' + (width_32_var + ',')) + ('height=' + (height_33_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_34_var));
	
	}
}

BreakoutGameNodeJS.prototype.drawPad = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawPad', 'void_', '', ''));
	let ps_var = Math.trunc(this.BreakoutGame_padlen_var / this.BreakoutGame_SCALE_var);
	this.erasePad();
	const old_prevPX_36_var = '' + this.BreakoutGame_prevPX_var;
	...
	const new_prevPX_36_var = '' + this.BreakoutGame_prevPX_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevPX', 'Int16', old_prevPX_36_var, new_prevPX_36_var));
	const old_prevPY_35_var = '' + this.BreakoutGame_prevPY_var;
	this.BreakoutGame_prevPY_var = Math.trunc(this.BreakoutGame_pady_var / this.BreakoutGame_SCALE_var);
	const new_prevPY_35_var = '' + this.BreakoutGame_prevPY_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'prevPY', 'Int16', old_prevPY_35_var, new_prevPY_35_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_35_var, g_36_var, b_37_var));
	const params_38_var = '' + ('r=' + (r_35_var + ',')) + ('g=' + (g_36_var + ',')) + ('b=' + (b_37_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_38_var));
	...
	this.bus.emit('display', new Event.FillRect('display', x_39_var, y_40_var, width_41_var, height_42_var));
	const params_43_var = '' + ('x=' + (x_39_var + ',')) + ('y=' + (y_40_var + ',')) + ('width=' + (width_41_var + ',')) + ('height=' + (height_42_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_43_var));
}
...
BreakoutGameNodeJS.prototype.drawCountDown = function(BreakoutGame_drawCountDown_c_var) {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawCountDown', 'void_', '', params_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_44_var, g_45_var, b_46_var));
	const params_47_var = '' + ('r=' + (r_44_var + ',')) + ('g=' + (g_45_var + ',')) + ('b=' + (b_46_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_47_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_48_var, g_49_var, b_50_var));
	const params_51_var = '' + ('r=' + (r_48_var + ',')) + ('g=' + (g_49_var + ',')) + ('b=' + (b_50_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_51_var));
	...
	;
	this.bus.emit('display', new Event.SetBGColor('display', r_52_var, g_53_var, b_54_var));
	const params_55_var = '' + ('r=' + (r_52_var + ',')) + ('g=' + (g_53_var + ',')) + ('b=' + (b_54_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setBGColor', params_55_var));
	const x_56_var = 80 - 6;
	const y_57_var = 90;
	const v_58_var = BreakoutGame_drawCountDown_c_var;
	const digits_59_var = 1;
	const scale_60_var = 4;
	this.bus.emit('display', new Event.DrawInteger('display', x_56_var, y_57_var, v_58_var, digits_59_var, scale_60_var));
	const params_61_var = '' + ('x=' + (x_56_var + ',')) + ('y=' + (y_57_var + ',')) + ('v=' + (v_58_var + ',')) + ('digits=' + (digits_59_var + ',')) + ('scale=' + (scale_60_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'drawInteger', params_61_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_62_var, g_63_var, b_64_var));
	const params_65_var = '' + ('r=' + (r_62_var + ',')) + ('g=' + (g_63_var + ',')) + ('b=' + (b_64_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_65_var));
	const x_66_var = 80 - 6;
	const y_67_var = 90;
	const width_68_var = 12;
	const height_69_var = 20;
	this.bus.emit('display', new Event.FillRect('display', x_66_var, y_67_var, width_68_var, height_69_var));
	const params_70_var = '' + ('x=' + (x_66_var + ',')) + ('y=' + (y_67_var + ',')) + ('width=' + (width_68_var + ',')) + ('height=' + (height_69_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_70_var));
	
	}
}

BreakoutGameNodeJS.prototype.drawWalls = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawWalls', 'void_', '', ''));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_71_var, g_72_var, b_73_var));
	const params_74_var = '' + ('r=' + (r_71_var + ',')) + ('g=' + (g_72_var + ',')) + ('b=' + (b_73_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_74_var));
	...
	this.bus.emit('display', new Event.FillRect('display', x_75_var, y_76_var, width_77_var, height_78_var));
	const params_79_var = '' + ('x=' + (x_75_var + ',')) + ('y=' + (y_76_var + ',')) + ('width=' + (width_77_var + ',')) + ('height=' + (height_78_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_79_var));
	const x_80_var = left_var - 1;
	const y_81_var = bottom_var;
	const width_82_var = xcenter_var + 1;
	const height_83_var = 1;
	this.bus.emit('display', new Event.FillRect('display', x_80_var, y_81_var, width_82_var, height_83_var));
	const params_84_var = '' + ('x=' + (x_80_var + ',')) + ('y=' + (y_81_var + ',')) + ('width=' + (width_82_var + ',')) + ('height=' + (height_83_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_84_var));
	const x_85_var = left_var - 1;
	const y_86_var = top_var;
	const width_87_var = 1;
	const height_88_var = ycenter_var;
	this.bus.emit('display', new Event.FillRect('display', x_85_var, y_86_var, width_87_var, height_88_var));
	const params_89_var = '' + ('x=' + (x_85_var + ',')) + ('y=' + (y_86_var + ',')) + ('width=' + (width_87_var + ',')) + ('height=' + (height_88_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_89_var));
	const x_90_var = right_var;
	const y_91_var = top_var;
	const width_92_var = 1;
	const height_93_var = ycenter_var;
	this.bus.emit('display', new Event.FillRect('display', x_90_var, y_91_var, width_92_var, height_93_var));
	const params_94_var = '' + ('x=' + (x_90_var + ',')) + ('y=' + (y_91_var + ',')) + ('width=' + (width_92_var + ',')) + ('height=' + (height_93_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_94_var));
}
...
BreakoutGameNodeJS.prototype.bitIsSet = function(BreakoutGame_bitIsSet_variable_var, BreakoutGame_bitIsSet_bit_var) {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'bitIsSet', 'Boolean', return_as_string0_var, params_var));
	return return_0_var;
}

BreakoutGameNodeJS.prototype.createBricks = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'createBricks', 'void_', '', ''));
	let y_var = 0;
...
BreakoutGameNodeJS.prototype.bricksLeft = function() {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'bricksLeft', 'UInt8', return_as_string3_var, ''));
	return return_3_var;
}
...
BreakoutGameNodeJS.prototype.drawBrick = function(BreakoutGame_drawBrick_x_var, BreakoutGame_drawBrick_y_var) {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawBrick', 'void_', '', params_var));
	...
	const g_96_var = 103;
	const b_97_var = 89;
	this.bus.emit('display', new Event.SetColor('display', r_95_var, g_96_var, b_97_var));
	const params_98_var = '' + ('r=' + (r_95_var + ',')) + ('g=' + (g_96_var + ',')) + ('b=' + (b_97_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_98_var));
	const x_99_var = bx_var;
	const y_100_var = by_var;
	const width_101_var = w_var;
	const height_102_var = h_var;
	this.bus.emit('display', new Event.FillRect('display', x_99_var, y_100_var, width_101_var, height_102_var));
	const params_103_var = '' + ('x=' + (x_99_var + ',')) + ('y=' + (y_100_var + ',')) + ('width=' + (width_101_var + ',')) + ('height=' + (height_102_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_103_var));
	const r_104_var = 100;
	const g_105_var = 56;
	const b_106_var = 43;
	this.bus.emit('display', new Event.SetColor('display', r_104_var, g_105_var, b_106_var));
	const params_107_var = '' + ('r=' + (r_104_var + ',')) + ('g=' + (g_105_var + ',')) + ('b=' + (b_106_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_107_var));
	const x_108_var = bx_var;
	const y_109_var = by_var;
	const width_110_var = w_var;
	const height_111_var = h_var;
	this.bus.emit('display', new Event.DrawRect('display', x_108_var, y_109_var, width_110_var, height_111_var));
	const params_112_var = '' + ('x=' + (x_108_var + ',')) + ('y=' + (y_109_var + ',')) + ('width=' + (width_110_var + ',')) + ('height=' + (height_111_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'drawRect', params_112_var));
}
...
BreakoutGameNodeJS.prototype.removeBrick = function(BreakoutGame_removeBrick_x_var, BreakoutGame_removeBrick_y_var) {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'removeBrick', 'void_', '', params_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_113_var, g_114_var, b_115_var));
	const params_116_var = '' + ('r=' + (r_113_var + ',')) + ('g=' + (g_114_var + ',')) + ('b=' + (b_115_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_116_var));
	...
	this.bus.emit('display', new Event.FillRect('display', x_117_var, y_118_var, width_119_var, height_120_var));
	const params_121_var = '' + ('x=' + (x_117_var + ',')) + ('y=' + (y_118_var + ',')) + ('width=' + (width_119_var + ',')) + ('height=' + (height_120_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_121_var));
...
BreakoutGameNodeJS.prototype.collideBrick = function(BreakoutGame_collideBrick_xpos_var, BreakoutGame_collideBrick_ypos_var) {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'collideBrick', 'Boolean', return_as_string3_var, params_var));
	return return_3_var;
}

BreakoutGameNodeJS.prototype.drawLevel = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawLevel', 'void_', '', ''));
	const r_122_var = 158;
	const g_123_var = 209;
	const b_124_var = 130;
	this.bus.emit('display', new Event.SetColor('display', r_122_var, g_123_var, b_124_var));
	const params_125_var = '' + ('r=' + (r_122_var + ',')) + ('g=' + (g_123_var + ',')) + ('b=' + (b_124_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_125_var));
	...
	;
	this.bus.emit('display', new Event.SetBGColor('display', r_126_var, g_127_var, b_128_var));
	const params_129_var = '' + ('r=' + (r_126_var + ',')) + ('g=' + (g_127_var + ',')) + ('b=' + (b_128_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setBGColor', params_129_var));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_130_var, g_131_var, b_132_var));
	const params_133_var = '' + ('r=' + (r_130_var + ',')) + ('g=' + (g_131_var + ',')) + ('b=' + (b_132_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_133_var));
	const x_134_var = 6;
	const y_135_var = 2;
	const v_136_var = this.BreakoutGame_level_var;
	const digits_137_var = 2;
	const scale_138_var = 2;
	this.bus.emit('display', new Event.DrawInteger('display', x_134_var, y_135_var, v_136_var, digits_137_var, scale_138_var));
	const params_139_var = '' + ('x=' + (x_134_var + ',')) + ('y=' + (y_135_var + ',')) + ('v=' + (v_136_var + ',')) + ('digits=' + (digits_137_var + ',')) + ('scale=' + (scale_138_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'drawInteger', params_139_var));
}
...
BreakoutGameNodeJS.prototype.incrementScore = function(BreakoutGame_incrementScore_diff_var) {
	...
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'incrementScore', 'void_', '', params_var));
	const old_score_37_var = '' + this.BreakoutGame_score_var;
	this.BreakoutGame_score_var = this.BreakoutGame_score_var + BreakoutGame_incrementScore_diff_var;
	const new_score_37_var = '' + this.BreakoutGame_score_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'score', 'Int16', old_score_37_var, new_score_37_var));
	if(this.BreakoutGame_score_var < 0) {
	const old_score_38_var = '' + this.BreakoutGame_score_var;
	this.BreakoutGame_score_var = 0;
	const new_score_38_var = '' + this.BreakoutGame_score_var;
	this.bus.emit('log', new Event.Property_changed('log', this.WithLog_DEBUG_ID_var, 'score', 'Int16', old_score_38_var, new_score_38_var));
...
BreakoutGameNodeJS.prototype.drawScore = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawScore', 'void_', '', ''));
	const r_140_var = 158;
	const g_141_var = 209;
	const b_142_var = 130;
	this.bus.emit('display', new Event.SetColor('display', r_140_var, g_141_var, b_142_var));
	const params_143_var = '' + ('r=' + (r_140_var + ',')) + ('g=' + (g_141_var + ',')) + ('b=' + (b_142_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_143_var));
	...
	;
	this.bus.emit('display', new Event.SetBGColor('display', r_144_var, g_145_var, b_146_var));
	const params_147_var = '' + ('r=' + (r_144_var + ',')) + ('g=' + (g_145_var + ',')) + ('b=' + (b_146_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setBGColor', params_147_var));
	const x_148_var = 58;
	const y_149_var = 2;
	const v_150_var = this.BreakoutGame_score_var;
	const digits_151_var = 5;
	const scale_152_var = 2;
	this.bus.emit('display', new Event.DrawInteger('display', x_148_var, y_149_var, v_150_var, digits_151_var, scale_152_var));
	const params_153_var = '' + ('x=' + (x_148_var + ',')) + ('y=' + (y_149_var + ',')) + ('v=' + (v_150_var + ',')) + ('digits=' + (digits_151_var + ',')) + ('scale=' + (scale_152_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'drawInteger', params_153_var));
}

BreakoutGameNodeJS.prototype.drawLives = function() {
	this.bus.emit('log', new Event.Function_called('log', this.WithLog_DEBUG_ID_var, 'drawLives', 'void_', '', ''));
	...
	;
	this.bus.emit('display', new Event.SetColor('display', r_154_var, g_155_var, b_156_var));
	const params_157_var = '' + ('r=' + (r_154_var + ',')) + ('g=' + (g_155_var + ',')) + ('b=' + (b_156_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_157_var));
	const x_158_var = 124;
	const y_159_var = 4;
	const width_160_var = 24 + 6;
	const height_161_var = 6;
	this.bus.emit('display', new Event.FillRect('display', x_158_var, y_159_var, width_160_var, height_161_var));
	const params_162_var = '' + ('x=' + (x_158_var + ',')) + ('y=' + (y_159_var + ',')) + ('width=' + (width_160_var + ',')) + ('height=' + (height_161_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_162_var));
	const r_163_var = 183;
	const g_164_var = 199;
	const b_165_var = 111;
	this.bus.emit('display', new Event.SetColor('display', r_163_var, g_164_var, b_165_var));
	const params_166_var = '' + ('r=' + (r_163_var + ',')) + ('g=' + (g_164_var + ',')) + ('b=' + (b_165_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'setColor', params_166_var));
	let i_var = 0;
	...
	this.bus.emit('display', new Event.FillRect('display', x_167_var, y_168_var, width_169_var, height_170_var));
	const params_171_var = '' + ('x=' + (x_167_var + ',')) + ('y=' + (y_168_var + ',')) + ('width=' + (width_169_var + ',')) + ('height=' + (height_170_var + ','));
	this.bus.emit('log', new Event.Message_sent('log', this.WithLog_DEBUG_ID_var, 'display', 'fillRect', params_171_var));
	i_var = i_var + 1;
