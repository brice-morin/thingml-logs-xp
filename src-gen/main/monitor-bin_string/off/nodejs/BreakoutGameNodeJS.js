...
BreakoutGameNodeJS.prototype.build = function(session) {
	...
	let BreakoutGame_SC_LAUNCH = new StateJS.State('LAUNCH', this._statemachine).entry(() => {
		...
		const countdown_log_26_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_26_var, this.BreakoutGame_SC_LAUNCH_countdown_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', countdown_log_26_var, 5));
		this.drawScore();
		this.drawLives();
	...
	let BreakoutGame_SC_LOSTBALL = new StateJS.State('LOSTBALL', this._statemachine).entry(() => {
		...
		const old_lives_12_var = this.BreakoutGame_lives_var;
		this.BreakoutGame_lives_var = this.BreakoutGame_lives_var - 1;
		const lives_log_12_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1C, old_lives_12_var, this.BreakoutGame_lives_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', lives_log_12_var, 5));
		this.eraseBall();
		this.erasePad();
		this.drawLives();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
	...
	let BreakoutGame_SC_NEXTLEVEL = new StateJS.State('NEXTLEVEL', this._statemachine).entry(() => {
		...
		const old_level_16_var = this.BreakoutGame_level_var;
		this.BreakoutGame_level_var = this.BreakoutGame_level_var + 1;
		const level_log_16_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1D, old_level_16_var, this.BreakoutGame_level_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', level_log_16_var, 5));
		this.drawLevel();
		this.eraseBall();
		this.erasePad();
		...
		const padlen_log_20_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x10, (((old_padlen_20_var >> 8) & 0xFF)), (((old_padlen_20_var >> 0) & 0xFF)), (((this.BreakoutGame_padlen_var >> 8) & 0xFF)), (((this.BreakoutGame_padlen_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', padlen_log_20_var, 7));
		
		}
		if((this.BreakoutGame_level_var % 2) === 1) {
		const old_dy_9_var = this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var = Math.trunc((this.BreakoutGame_dy_var * 3) / 2);
		const dy_log_9_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_9_var >> 8) & 0xFF)), (((old_dy_9_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_9_var, 7));
	...
	BreakoutGame_SC_INIT.to(BreakoutGame_SC_LAUNCH).on(Event.DisplayReady_DisplayMsgs).when((displayReady) => {
		...
		const displayReadyhandled_log_275_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', displayReadyhandled_log_275_var, 6));
	...
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_280_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x09, timer_timeout.id];
	...
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_GAMEOVER).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_281_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, timer_timeout.id];
	...
	BreakoutGame_SC_PLAY.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_279_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04, timer_timeout.id];
		...
		const bx_log_22_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_22_var >> 8) & 0xFF)), (((old_bx_22_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
		...
		const by_log_29_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_29_var >> 8) & 0xFF)), (((old_by_29_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
		...
		const old_dx_2_var = this.BreakoutGame_dx_var;
		this.BreakoutGame_dx_var =  -this.BreakoutGame_dx_var;
		const dx_log_2_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_2_var >> 8) & 0xFF)), (((old_dx_2_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_2_var, 7));
		const old_bx_23_var = this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = 2 * wl_var - this.BreakoutGame_bx_var;
		const bx_log_23_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_23_var >> 8) & 0xFF)), (((old_bx_23_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_23_var, 7));
		this.incrementScore( -1);
		
		} else {
		if(this.BreakoutGame_bx_var > wr_var) {
		const old_dx_3_var = this.BreakoutGame_dx_var;
		this.BreakoutGame_dx_var =  -this.BreakoutGame_dx_var;
		const dx_log_3_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_3_var >> 8) & 0xFF)), (((old_dx_3_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_3_var, 7));
		const old_bx_24_var = this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = 2 * wr_var - this.BreakoutGame_bx_var;
		const bx_log_24_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_24_var >> 8) & 0xFF)), (((old_bx_24_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
		...
		const dy_log_6_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_6_var >> 8) & 0xFF)), (((old_dy_6_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		...
		const by_log_30_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_30_var >> 8) & 0xFF)), (((old_by_30_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
		...
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const dy_log_7_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_7_var >> 8) & 0xFF)), (((old_dy_7_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		...
		const by_log_31_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_31_var >> 8) & 0xFF)), (((old_by_31_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_31_var, 7));
		const old_dx_4_var = this.BreakoutGame_dx_var;
		...
		const dx_log_4_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_4_var >> 8) & 0xFF)), (((old_dx_4_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_4_var, 7));
		...
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const dy_log_8_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_8_var >> 8) & 0xFF)), (((old_dy_8_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
	...
	BreakoutGame_SC_NEXTLEVEL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_276_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_276_var, 7));
	});
	BreakoutGame_SC_LAUNCH.to(BreakoutGame_SC_PLAY).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_277_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x03, timer_timeout.id];
	...
	BreakoutGame_SC_LAUNCH.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_278_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x02, timer_timeout.id];
		...
		const old_countdown_27_var = this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = this.BreakoutGame_SC_LAUNCH_countdown_var - 1;
		const countdown_log_27_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_27_var, this.BreakoutGame_SC_LAUNCH_countdown_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', countdown_log_27_var, 5));
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_LOSTBALL).on(Event.LostBall_BreakoutGame).when((lostBall) => {
		...
		const lostBallhandled_log_273_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x05];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_NEXTLEVEL).on(Event.NextLevel_BreakoutGame).when((nextLevel) => {
		...
		const nextLevelhandled_log_274_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x06];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_LOSTBALL).on(Event.LostBall_BreakoutGame).when((lostBall) => {
		...
		const lostBallhandled_log_271_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x07];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_NEXTLEVEL).on(Event.NextLevel_BreakoutGame).when((nextLevel) => {
		...
		const nextLevelhandled_log_272_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x08];
	...
	this._statemachine.on(Event.Position).when((position) => {
		...
		const positionhandled_log_282_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, (((position.x >> 8) & 0xFF)), (((position.x >> 0) & 0xFF)), (((position.y >> 8) & 0xFF)), (((position.y >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', positionhandled_log_282_var, 10));
		...
		const old_padx_32_var = this.BreakoutGame_padx_var;
		...
		const padx_log_32_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_padx_32_var >> 8) & 0xFF)), (((old_padx_32_var >> 0) & 0xFF)), (((this.BreakoutGame_padx_var >> 8) & 0xFF)), (((this.BreakoutGame_padx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', padx_log_32_var, 7));
	});
}
...
BreakoutGameNodeJS.prototype.resetBall = function() {
	...
	const bx_log_21_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_21_var >> 8) & 0xFF)), (((old_bx_21_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
	...
	const old_dx_1_var = this.BreakoutGame_dx_var;
	this.BreakoutGame_dx_var = (this.BreakoutGame_padx_var + this.BreakoutGame_prevBX_var + this.BreakoutGame_prevBY_var) % 300 - 150;
	const dx_log_1_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_1_var >> 8) & 0xFF)), (((old_dx_1_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_1_var, 7));
	if(this.BreakoutGame_dy_var > 0) {
	const old_dy_5_var = this.BreakoutGame_dy_var;
	this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
	const dy_log_5_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_5_var >> 8) & 0xFF)), (((old_dy_5_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
	...
	const prevBX_log_13_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_13_var >> 8) & 0xFF)), (((old_prevBX_13_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_13_var, 7));
...
BreakoutGameNodeJS.prototype.eraseBall = function() {
	...
	this.BreakoutGame_prevBX_var =  -1;
	const prevBX_log_14_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_14_var >> 8) & 0xFF)), (((old_prevBX_14_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_14_var, 7));
	const old_prevBY_18_var = this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const prevBY_log_18_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_18_var >> 8) & 0xFF)), (((old_prevBY_18_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 0) & 0xFF))];
...
BreakoutGameNodeJS.prototype.drawBall = function() {
	let bs_var = Math.trunc((this.BreakoutGame_br_var * 2) / this.BreakoutGame_SCALE_var);
	this.eraseBall();
	const old_prevBX_15_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var = Math.trunc((this.BreakoutGame_bx_var - this.BreakoutGame_br_var) / this.BreakoutGame_SCALE_var);
	const prevBX_log_15_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_15_var >> 8) & 0xFF)), (((old_prevBX_15_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_15_var, 7));
	...
	const prevBY_log_19_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_19_var >> 8) & 0xFF)), (((old_prevBY_19_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 0) & 0xFF))];
...
BreakoutGameNodeJS.prototype.drawPad = function() {
	let ps_var = Math.trunc(this.BreakoutGame_padlen_var / this.BreakoutGame_SCALE_var);
	this.erasePad();
	const old_prevPX_25_var = this.BreakoutGame_prevPX_var;
	...
	const prevPX_log_25_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x16, (((old_prevPX_25_var >> 8) & 0xFF)), (((old_prevPX_25_var >> 0) & 0xFF)), (((this.BreakoutGame_prevPX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevPX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevPX_log_25_var, 7));
	const old_prevPY_0_var = this.BreakoutGame_prevPY_var;
	this.BreakoutGame_prevPY_var = Math.trunc(this.BreakoutGame_pady_var / this.BreakoutGame_SCALE_var);
	const prevPY_log_0_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x17, (((old_prevPY_0_var >> 8) & 0xFF)), (((old_prevPY_0_var >> 0) & 0xFF)), (((this.BreakoutGame_prevPY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevPY_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevPY_log_0_var, 7));
...
BreakoutGameNodeJS.prototype.incrementScore = function(BreakoutGame_incrementScore_diff_var) {
	...
	const score_log_11_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_11_var >> 8) & 0xFF)), (((old_score_11_var >> 0) & 0xFF)), (((this.BreakoutGame_score_var >> 8) & 0xFF)), (((this.BreakoutGame_score_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', score_log_11_var, 7));
