...
#define BREAKOUTGAME_SC_GAMEOVER_STATE 4
...
int16_t new_dx_20 = _instance->BreakoutGame_dx_var;
uint8_t dx_log_20[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dx_20 >> 8) & 0xFF)), (((old_dx_20 >> 0) & 0xFF)), (((new_dx_20 >> 8) & 0xFF)), (((new_dx_20 >> 0) & 0xFF))};
...
int16_t old_prevBX_16 = _instance->BreakoutGame_prevBX_var;
_instance->BreakoutGame_prevBX_var =  -1;
int16_t new_prevBX_16 = _instance->BreakoutGame_prevBX_var;
uint8_t prevBX_log_16[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBX_16 >> 8) & 0xFF)), (((old_prevBX_16 >> 0) & 0xFF)), (((new_prevBX_16 >> 8) & 0xFF)), (((new_prevBX_16 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevBX_log_16, 7);
int16_t old_prevBY_11 = _instance->BreakoutGame_prevBY_var;
_instance->BreakoutGame_prevBY_var =  -1;
int16_t new_prevBY_11 = _instance->BreakoutGame_prevBY_var;
uint8_t prevBY_log_11[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x13, (((old_prevBY_11 >> 8) & 0xFF)), (((old_prevBY_11 >> 0) & 0xFF)), (((new_prevBY_11 >> 8) & 0xFF)), (((new_prevBY_11 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevBY_log_11, 7);
...
int16_t old_prevBX_17 = _instance->BreakoutGame_prevBX_var;
_instance->BreakoutGame_prevBX_var =  -1;
int16_t new_prevBX_17 = _instance->BreakoutGame_prevBX_var;
uint8_t prevBX_log_17[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBX_17 >> 8) & 0xFF)), (((old_prevBX_17 >> 0) & 0xFF)), (((new_prevBX_17 >> 8) & 0xFF)), (((new_prevBX_17 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevBX_log_17, 7);
int16_t old_prevBY_12 = _instance->BreakoutGame_prevBY_var;
_instance->BreakoutGame_prevBY_var =  -1;
int16_t new_prevBY_12 = _instance->BreakoutGame_prevBY_var;
uint8_t prevBY_log_12[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x13, (((old_prevBY_12 >> 8) & 0xFF)), (((old_prevBY_12 >> 0) & 0xFF)), (((new_prevBY_12 >> 8) & 0xFF)), (((new_prevBY_12 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevBY_log_12, 7);
...
int16_t old_prevBX_18 = _instance->BreakoutGame_prevBX_var;
...
int16_t new_prevBX_18 = _instance->BreakoutGame_prevBX_var;
uint8_t prevBX_log_18[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBX_18 >> 8) & 0xFF)), (((old_prevBX_18 >> 0) & 0xFF)), (((new_prevBX_18 >> 8) & 0xFF)), (((new_prevBX_18 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevBX_log_18, 7);
...
int16_t old_prevPX_0 = _instance->BreakoutGame_prevPX_var;
...
int16_t new_prevPX_0 = _instance->BreakoutGame_prevPX_var;
uint8_t prevPX_log_0[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x17, (((old_prevPX_0 >> 8) & 0xFF)), (((old_prevPX_0 >> 0) & 0xFF)), (((new_prevPX_0 >> 8) & 0xFF)), (((new_prevPX_0 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevPX_log_0, 7);
int16_t old_prevPY_15 = _instance->BreakoutGame_prevPY_var;
_instance->BreakoutGame_prevPY_var = _instance->BreakoutGame_pady_var / _instance->BreakoutGame_SCALE_var;
int16_t new_prevPY_15 = _instance->BreakoutGame_prevPY_var;
uint8_t prevPY_log_15[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x18, (((old_prevPY_15 >> 8) & 0xFF)), (((old_prevPY_15 >> 0) & 0xFF)), (((new_prevPY_15 >> 8) & 0xFF)), (((new_prevPY_15 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, prevPY_log_15, 7);
...
uint8_t old_lives_2 = _instance->BreakoutGame_lives_var;
_instance->BreakoutGame_lives_var = _instance->BreakoutGame_lives_var - 1;
uint8_t new_lives_2 = _instance->BreakoutGame_lives_var;
uint8_t lives_log_2[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1D, old_lives_2, new_lives_2};
BreakoutGameArduino_send_log_log(_instance, lives_log_2, 5);
f_BreakoutGameArduino_eraseBall(_instance);
f_BreakoutGameArduino_erasePad(_instance);
...
uint8_t old_countdown_3 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
_instance->BreakoutGame_SC_LAUNCH_countdown_var = 3;
uint8_t new_countdown_3 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
uint8_t countdown_log_3[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1F, old_countdown_3, new_countdown_3};
BreakoutGameArduino_send_log_log(_instance, countdown_log_3, 5);
f_BreakoutGameArduino_drawScore(_instance);
f_BreakoutGameArduino_drawLives(_instance);
BreakoutGameArduino_send_display_update(_instance);
...
uint8_t old_level_19 = _instance->BreakoutGame_level_var;
_instance->BreakoutGame_level_var = _instance->BreakoutGame_level_var + 1;
uint8_t new_level_19 = _instance->BreakoutGame_level_var;
uint8_t level_log_19[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_level_19, new_level_19};
BreakoutGameArduino_send_log_log(_instance, level_log_19, 5);
...
int16_t old_padlen_1 = _instance->BreakoutGame_padlen_var;
_instance->BreakoutGame_padlen_var = _instance->BreakoutGame_padlen_var - (4 * _instance->BreakoutGame_SCALE_var);
int16_t new_padlen_1 = _instance->BreakoutGame_padlen_var;
uint8_t padlen_log_1[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_padlen_1 >> 8) & 0xFF)), (((old_padlen_1 >> 0) & 0xFF)), (((new_padlen_1 >> 8) & 0xFF)), (((new_padlen_1 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, padlen_log_1, 7);
...
uint8_t dy_log_28[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_28 >> 8) & 0xFF)), (((old_dy_28 >> 0) & 0xFF)), (((new_dy_28 >> 8) & 0xFF)), (((new_dy_28 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, dy_log_28, 7);
...
uint8_t timer_timeouthandled_log_279[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x02, 0x03, id};
BreakoutGameArduino_send_log_log(_instance, timer_timeouthandled_log_279, 7);
...
uint8_t timer_timeouthandled_log_280[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x02, 0x00, id};
BreakoutGameArduino_send_log_log(_instance, timer_timeouthandled_log_280, 7);
uint8_t id_198 = 0;
...
uint8_t new_countdown_4 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
uint8_t countdown_log_4[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1F, old_countdown_4, new_countdown_4};
...
uint8_t timer_timeouthandled_log_277[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x03, 0x00, id};
BreakoutGameArduino_send_log_log(_instance, timer_timeouthandled_log_277, 7);
...
int16_t new_bx_8 = _instance->BreakoutGame_bx_var;
uint8_t bx_log_8[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_8 >> 8) & 0xFF)), (((old_bx_8 >> 0) & 0xFF)), (((new_bx_8 >> 8) & 0xFF)), (((new_bx_8 >> 0) & 0xFF))};
...
int16_t new_dx_21 = _instance->BreakoutGame_dx_var;
uint8_t dx_log_21[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dx_21 >> 8) & 0xFF)), (((old_dx_21 >> 0) & 0xFF)), (((new_dx_21 >> 8) & 0xFF)), (((new_dx_21 >> 0) & 0xFF))};
...
int16_t new_bx_9 = _instance->BreakoutGame_bx_var;
uint8_t bx_log_9[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_9 >> 8) & 0xFF)), (((old_bx_9 >> 0) & 0xFF)), (((new_bx_9 >> 8) & 0xFF)), (((new_bx_9 >> 0) & 0xFF))};
...
uint8_t bx_log_10[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_10 >> 8) & 0xFF)), (((old_bx_10 >> 0) & 0xFF)), (((new_bx_10 >> 8) & 0xFF)), (((new_bx_10 >> 0) & 0xFF))};
...
int16_t old_dy_25 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
int16_t new_dy_25 = _instance->BreakoutGame_dy_var;
uint8_t dy_log_25[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_25 >> 8) & 0xFF)), (((old_dy_25 >> 0) & 0xFF)), (((new_dy_25 >> 8) & 0xFF)), (((new_dy_25 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, dy_log_25, 7);
...
int16_t old_dy_26 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
int16_t new_dy_26 = _instance->BreakoutGame_dy_var;
uint8_t dy_log_26[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_26 >> 8) & 0xFF)), (((old_dy_26 >> 0) & 0xFF)), (((new_dy_26 >> 8) & 0xFF)), (((new_dy_26 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, dy_log_26, 7);
...
uint8_t dy_log_27[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_27 >> 8) & 0xFF)), (((old_dy_27 >> 0) & 0xFF)), (((new_dy_27 >> 8) & 0xFF)), (((new_dy_27 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, dy_log_27, 7);
...
uint8_t timer_timeouthandled_log_281[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x04, 0x02, id};
BreakoutGameArduino_send_log_log(_instance, timer_timeouthandled_log_281, 7);
...
uint8_t timer_timeouthandled_log_282[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x04, 0x06, id};
BreakoutGameArduino_send_log_log(_instance, timer_timeouthandled_log_282, 7);
...
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LAUNCH_STATE;
uint8_t timer_timeouthandled_log_278[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x05, 0x02, id};
BreakoutGameArduino_send_log_log(_instance, timer_timeouthandled_log_278, 7);
BreakoutGame_SC_OnEntry(BREAKOUTGAME_SC_LAUNCH_STATE, _instance);
BreakoutGame_SC_State_event_consumed = 1;
}
}
...
//Session list: 
if (1) {
uint8_t positionhandled_log_271[10] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x03, 0x12, 0x00, 0x00, (((x >> 8) & 0xFF)), (((x >> 0) & 0xFF)), (((y >> 8) & 0xFF)), (((y >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, positionhandled_log_271, 10);
int32_t center = (_instance->BreakoutGame_RIGHT_var - _instance->BreakoutGame_LEFT_var - _instance->BreakoutGame_padlen_var);
center = x * center;
center = center / 200;
int16_t old_padx_14 = _instance->BreakoutGame_padx_var;
...
int16_t new_padx_14 = _instance->BreakoutGame_padx_var;
uint8_t padx_log_14[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0F, (((old_padx_14 >> 8) & 0xFF)), (((old_padx_14 >> 0) & 0xFF)), (((new_padx_14 >> 8) & 0xFF)), (((new_padx_14 >> 0) & 0xFF))};
BreakoutGameArduino_send_log_log(_instance, padx_log_14, 7);
BreakoutGame_SC_State_event_consumed = 1;
}
}
void BreakoutGameArduino_handle_game_lostBall(struct BreakoutGameArduino_Instance *_instance) {
...
uint8_t lostBallhandled_log_272[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x05, 0x01, 0x03, 0x04};
BreakoutGameArduino_send_log_log(_instance, lostBallhandled_log_272, 6);
uint8_t id_219 = 0;
...
uint8_t nextLevelhandled_log_273[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x05, 0x02, 0x03, 0x05};
BreakoutGameArduino_send_log_log(_instance, nextLevelhandled_log_273, 6);
uint8_t id_221 = 0;
...
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LAUNCH_STATE;
uint8_t displayReadyhandled_log_274[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x02, 0x10, 0x01, 0x02};
BreakoutGameArduino_send_log_log(_instance, displayReadyhandled_log_274, 6);
...
BreakoutGame_SC_OnExit(BREAKOUTGAME_SC_PLAY_STATE, _instance);
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LOSTBALL_STATE;
uint8_t lostBallhandled_log_275[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x07, 0x01, 0x03, 0x04};
BreakoutGameArduino_send_log_log(_instance, lostBallhandled_log_275, 6);
uint8_t id_223 = 0;
...
BreakoutGame_SC_OnExit(BREAKOUTGAME_SC_PLAY_STATE, _instance);
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_NEXTLEVEL_STATE;
uint8_t nextLevelhandled_log_276[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x07, 0x02, 0x03, 0x05};
BreakoutGameArduino_send_log_log(_instance, nextLevelhandled_log_276, 6);
uint8_t id_225 = 0;
...
String f_Binary2StringLogger_stateName(struct Binary2StringLogger_Instance *_instance, uint8_t id);
...
uint8_t id = (bin_id[0] << 0);
Serial.print("message_handled(BreakoutGame0, clock, timer_timeout, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(", id=");
Serial.print(id);
Serial.print(")");
Serial.print("\n");
...
if(portID == 2 && messageID == 16) {
Serial.print("message_handled(BreakoutGame0, display, displayReady, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(")");
...
Serial.print("message_handled(BreakoutGame0, controller, position, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(", x=");
...
if(portID == 5 && messageID == 1) {
Serial.print("message_handled(BreakoutGame0, game, lostBall, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(")");
...
if(portID == 7 && messageID == 1) {
Serial.print("message_handled(BreakoutGame0, pro_game, lostBall, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(")");
...
if(portID == 5 && messageID == 2) {
Serial.print("message_handled(BreakoutGame0, game, nextLevel, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(")");
...
if(portID == 7 && messageID == 2) {
Serial.print("message_handled(BreakoutGame0, pro_game, nextLevel, ");
Serial.print(f_Binary2StringLogger_stateName(_instance, sourceID));
Serial.print(", ");
Serial.print(f_Binary2StringLogger_stateName(_instance, targetID));
Serial.print(")");
