...
func main() {
	...
	log := NewThingBinary2StringLogger()
	...
	gosm.Connector(game.Component, log.Component, BreakoutGameGo_WithBinaryLog_log, Binary2StringLogger_Logger_log)
	...
	game.level = 1
	ctrl.ctrlx = 0
	log.ACTIVATE_ON_STARTUP = true
	log.HAS_SIGNED_BYTE = false
	/* -- Start execution -- */
