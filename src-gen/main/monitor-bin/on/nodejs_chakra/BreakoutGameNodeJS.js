...
BreakoutGameNodeJS.prototype.build = function(session) {
	...
	let BreakoutGame_SC_LAUNCH = new StateJS.State('LAUNCH', this._statemachine).entry(() => {
		...
		const old_countdown_31_var = this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = 3;
		const new_countdown_31_var = this.BreakoutGame_SC_LAUNCH_countdown_var;
		const countdown_log_31_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1F, old_countdown_31_var, new_countdown_31_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', countdown_log_31_var, 5));
		this.drawScore();
		this.drawLives();
	...
	let BreakoutGame_SC_LOSTBALL = new StateJS.State('LOSTBALL', this._statemachine).entry(() => {
		...
		const old_lives_9_var = this.BreakoutGame_lives_var;
		this.BreakoutGame_lives_var = this.BreakoutGame_lives_var - 1;
		const new_lives_9_var = this.BreakoutGame_lives_var;
		const lives_log_9_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1D, old_lives_9_var, new_lives_9_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', lives_log_9_var, 5));
		this.eraseBall();
		this.erasePad();
		this.drawLives();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
	...
	let BreakoutGame_SC_NEXTLEVEL = new StateJS.State('NEXTLEVEL', this._statemachine).entry(() => {
		...
		const level_log_3_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_level_3_var, new_level_3_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', level_log_3_var, 5));
		this.drawLevel();
		this.eraseBall();
		this.erasePad();
		if((this.BreakoutGame_level_var % 2) === 0 && this.BreakoutGame_padlen_var > 5 * this.BreakoutGame_SCALE_var) {
		const old_padlen_25_var = this.BreakoutGame_padlen_var;
		this.BreakoutGame_padlen_var = this.BreakoutGame_padlen_var - (4 * this.BreakoutGame_SCALE_var);
		const new_padlen_25_var = this.BreakoutGame_padlen_var;
		const padlen_log_25_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_padlen_25_var >> 8) & 0xFF)), (((old_padlen_25_var >> 0) & 0xFF)), (((new_padlen_25_var >> 8) & 0xFF)), (((new_padlen_25_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', padlen_log_25_var, 7));
		
		}
		if((this.BreakoutGame_level_var % 2) === 1) {
		const old_dy_30_var = this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var = Math.trunc((this.BreakoutGame_dy_var * 3) / 2);
		const new_dy_30_var = this.BreakoutGame_dy_var;
		const dy_log_30_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_30_var >> 8) & 0xFF)), (((old_dy_30_var >> 0) & 0xFF)), (((new_dy_30_var >> 8) & 0xFF)), (((new_dy_30_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_30_var, 7));
	...
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_277_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x04, 0x02, timer_timeout.id];
	...
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_GAMEOVER).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_278_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x04, 0x06, timer_timeout.id];
	...
	BreakoutGame_SC_LAUNCH.to(BreakoutGame_SC_PLAY).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_279_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x02, 0x03, timer_timeout.id];
	...
	BreakoutGame_SC_LAUNCH.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_280_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x02, 0x00, timer_timeout.id];
		...
		const old_countdown_32_var = this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = this.BreakoutGame_SC_LAUNCH_countdown_var - 1;
		const new_countdown_32_var = this.BreakoutGame_SC_LAUNCH_countdown_var;
		const countdown_log_32_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1F, old_countdown_32_var, new_countdown_32_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', countdown_log_32_var, 5));
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
	...
	BreakoutGame_SC_PLAY.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const old_bx_20_var = this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = this.BreakoutGame_bx_var + this.BreakoutGame_dx_var;
		const new_bx_20_var = this.BreakoutGame_bx_var;
		const bx_log_20_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_20_var >> 8) & 0xFF)), (((old_bx_20_var >> 0) & 0xFF)), (((new_bx_20_var >> 8) & 0xFF)), (((new_bx_20_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_20_var, 7));
		const old_by_6_var = this.BreakoutGame_by_var;
		this.BreakoutGame_by_var = this.BreakoutGame_by_var + this.BreakoutGame_dy_var;
		const new_by_6_var = this.BreakoutGame_by_var;
		const by_log_6_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_by_6_var >> 8) & 0xFF)), (((old_by_6_var >> 0) & 0xFF)), (((new_by_6_var >> 8) & 0xFF)), (((new_by_6_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_6_var, 7));
		...
		const dx_log_12_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dx_12_var >> 8) & 0xFF)), (((old_dx_12_var >> 0) & 0xFF)), (((new_dx_12_var >> 8) & 0xFF)), (((new_dx_12_var >> 0) & 0xFF))];
		...
		const bx_log_21_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_21_var >> 8) & 0xFF)), (((old_bx_21_var >> 0) & 0xFF)), (((new_bx_21_var >> 8) & 0xFF)), (((new_bx_21_var >> 0) & 0xFF))];
		...
		const dx_log_13_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dx_13_var >> 8) & 0xFF)), (((old_dx_13_var >> 0) & 0xFF)), (((new_dx_13_var >> 8) & 0xFF)), (((new_dx_13_var >> 0) & 0xFF))];
		...
		const bx_log_22_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_22_var >> 8) & 0xFF)), (((old_bx_22_var >> 0) & 0xFF)), (((new_bx_22_var >> 8) & 0xFF)), (((new_bx_22_var >> 0) & 0xFF))];
		...
		const dy_log_27_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_27_var >> 8) & 0xFF)), (((old_dy_27_var >> 0) & 0xFF)), (((new_dy_27_var >> 8) & 0xFF)), (((new_dy_27_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_27_var, 7));
		const old_by_7_var = this.BreakoutGame_by_var;
		this.BreakoutGame_by_var = 2 * wt_var - this.BreakoutGame_by_var;
		const new_by_7_var = this.BreakoutGame_by_var;
		const by_log_7_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_by_7_var >> 8) & 0xFF)), (((old_by_7_var >> 0) & 0xFF)), (((new_by_7_var >> 8) & 0xFF)), (((new_by_7_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_7_var, 7));
		this.incrementScore( -1);
		...
		const dy_log_28_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_28_var >> 8) & 0xFF)), (((old_dy_28_var >> 0) & 0xFF)), (((new_dy_28_var >> 8) & 0xFF)), (((new_dy_28_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_28_var, 7));
		const old_by_8_var = this.BreakoutGame_by_var;
		this.BreakoutGame_by_var = 2 * (this.BreakoutGame_pady_var - this.BreakoutGame_br_var) - this.BreakoutGame_by_var;
		const new_by_8_var = this.BreakoutGame_by_var;
		const by_log_8_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_by_8_var >> 8) & 0xFF)), (((old_by_8_var >> 0) & 0xFF)), (((new_by_8_var >> 8) & 0xFF)), (((new_by_8_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_8_var, 7));
		...
		const dx_log_14_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dx_14_var >> 8) & 0xFF)), (((old_dx_14_var >> 0) & 0xFF)), (((new_dx_14_var >> 8) & 0xFF)), (((new_dx_14_var >> 0) & 0xFF))];
		...
		if(collision_var) {
		const old_dy_29_var = this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const new_dy_29_var = this.BreakoutGame_dy_var;
		const dy_log_29_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_29_var >> 8) & 0xFF)), (((old_dy_29_var >> 0) & 0xFF)), (((new_dy_29_var >> 8) & 0xFF)), (((new_dy_29_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_29_var, 7));
	...
	this._statemachine.on(Event.Position).when((position) => {
		...
		const positionhandled_log_276_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x03, 0x12, 0x00, 0x00, (((position.x >> 8) & 0xFF)), (((position.x >> 0) & 0xFF)), (((position.y >> 8) & 0xFF)), (((position.y >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', positionhandled_log_276_var, 10));
		...
		const old_padx_18_var = this.BreakoutGame_padx_var;
		...
		const new_padx_18_var = this.BreakoutGame_padx_var;
		const padx_log_18_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0F, (((old_padx_18_var >> 8) & 0xFF)), (((old_padx_18_var >> 0) & 0xFF)), (((new_padx_18_var >> 8) & 0xFF)), (((new_padx_18_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', padx_log_18_var, 7));
	});
	...
	BreakoutGame_SC_INIT.to(BreakoutGame_SC_LAUNCH).on(Event.DisplayReady_DisplayMsgs).when((displayReady) => {
		...
		const displayReadyhandled_log_275_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x02, 0x10, 0x01, 0x02];
...
BreakoutGameNodeJS.prototype.resetBall = function() {
	...
	const bx_log_19_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_bx_19_var >> 8) & 0xFF)), (((old_bx_19_var >> 0) & 0xFF)), (((new_bx_19_var >> 8) & 0xFF)), (((new_bx_19_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_19_var, 7));
	const old_by_5_var = this.BreakoutGame_by_var;
	this.BreakoutGame_by_var = this.BreakoutGame_pady_var - Math.trunc(this.BreakoutGame_br_var / this.BreakoutGame_SCALE_var);
	const new_by_5_var = this.BreakoutGame_by_var;
	const by_log_5_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_by_5_var >> 8) & 0xFF)), (((old_by_5_var >> 0) & 0xFF)), (((new_by_5_var >> 8) & 0xFF)), (((new_by_5_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_5_var, 7));
	...
	const dx_log_11_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dx_11_var >> 8) & 0xFF)), (((old_dx_11_var >> 0) & 0xFF)), (((new_dx_11_var >> 8) & 0xFF)), (((new_dx_11_var >> 0) & 0xFF))];
	...
	const dy_log_26_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_dy_26_var >> 8) & 0xFF)), (((old_dy_26_var >> 0) & 0xFF)), (((new_dy_26_var >> 8) & 0xFF)), (((new_dy_26_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_26_var, 7));
	
	}
	const old_prevBX_0_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const new_prevBX_0_var = this.BreakoutGame_prevBX_var;
	const prevBX_log_0_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBX_0_var >> 8) & 0xFF)), (((old_prevBX_0_var >> 0) & 0xFF)), (((new_prevBX_0_var >> 8) & 0xFF)), (((new_prevBX_0_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_0_var, 7));
	...
	const prevBY_log_15_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x13, (((old_prevBY_15_var >> 8) & 0xFF)), (((old_prevBY_15_var >> 0) & 0xFF)), (((new_prevBY_15_var >> 8) & 0xFF)), (((new_prevBY_15_var >> 0) & 0xFF))];
...
BreakoutGameNodeJS.prototype.eraseBall = function() {
	...
	const old_prevBX_1_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const new_prevBX_1_var = this.BreakoutGame_prevBX_var;
	const prevBX_log_1_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBX_1_var >> 8) & 0xFF)), (((old_prevBX_1_var >> 0) & 0xFF)), (((new_prevBX_1_var >> 8) & 0xFF)), (((new_prevBX_1_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_1_var, 7));
	const old_prevBY_16_var = this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const new_prevBY_16_var = this.BreakoutGame_prevBY_var;
	const prevBY_log_16_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x13, (((old_prevBY_16_var >> 8) & 0xFF)), (((old_prevBY_16_var >> 0) & 0xFF)), (((new_prevBY_16_var >> 8) & 0xFF)), (((new_prevBY_16_var >> 0) & 0xFF))];
...
BreakoutGameNodeJS.prototype.drawBall = function() {
	let bs_var = Math.trunc((this.BreakoutGame_br_var * 2) / this.BreakoutGame_SCALE_var);
	this.eraseBall();
	const old_prevBX_2_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var = Math.trunc((this.BreakoutGame_bx_var - this.BreakoutGame_br_var) / this.BreakoutGame_SCALE_var);
	const new_prevBX_2_var = this.BreakoutGame_prevBX_var;
	const prevBX_log_2_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBX_2_var >> 8) & 0xFF)), (((old_prevBX_2_var >> 0) & 0xFF)), (((new_prevBX_2_var >> 8) & 0xFF)), (((new_prevBX_2_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_2_var, 7));
	...
	const prevBY_log_17_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x13, (((old_prevBY_17_var >> 8) & 0xFF)), (((old_prevBY_17_var >> 0) & 0xFF)), (((new_prevBY_17_var >> 8) & 0xFF)), (((new_prevBY_17_var >> 0) & 0xFF))];
...
BreakoutGameNodeJS.prototype.drawPad = function() {
	let ps_var = Math.trunc(this.BreakoutGame_padlen_var / this.BreakoutGame_SCALE_var);
	this.erasePad();
	const old_prevPX_4_var = this.BreakoutGame_prevPX_var;
	...
	const new_prevPX_4_var = this.BreakoutGame_prevPX_var;
	const prevPX_log_4_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x17, (((old_prevPX_4_var >> 8) & 0xFF)), (((old_prevPX_4_var >> 0) & 0xFF)), (((new_prevPX_4_var >> 8) & 0xFF)), (((new_prevPX_4_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevPX_log_4_var, 7));
	const old_prevPY_10_var = this.BreakoutGame_prevPY_var;
	this.BreakoutGame_prevPY_var = Math.trunc(this.BreakoutGame_pady_var / this.BreakoutGame_SCALE_var);
	const new_prevPY_10_var = this.BreakoutGame_prevPY_var;
	const prevPY_log_10_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x18, (((old_prevPY_10_var >> 8) & 0xFF)), (((old_prevPY_10_var >> 0) & 0xFF)), (((new_prevPY_10_var >> 8) & 0xFF)), (((new_prevPY_10_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevPY_log_10_var, 7));
...
BreakoutGameNodeJS.prototype.incrementScore = function(BreakoutGame_incrementScore_diff_var) {
	const old_score_23_var = this.BreakoutGame_score_var;
	this.BreakoutGame_score_var = this.BreakoutGame_score_var + BreakoutGame_incrementScore_diff_var;
	const new_score_23_var = this.BreakoutGame_score_var;
	const score_log_23_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1C, (((old_score_23_var >> 8) & 0xFF)), (((old_score_23_var >> 0) & 0xFF)), (((new_score_23_var >> 8) & 0xFF)), (((new_score_23_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', score_log_23_var, 7));
	if(this.BreakoutGame_score_var < 0) {
	const old_score_24_var = this.BreakoutGame_score_var;
	this.BreakoutGame_score_var = 0;
	const new_score_24_var = this.BreakoutGame_score_var;
	const score_log_24_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1C, (((old_score_24_var >> 8) & 0xFF)), (((old_score_24_var >> 0) & 0xFF)), (((new_score_24_var >> 8) & 0xFF)), (((new_score_24_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', score_log_24_var, 7));
...
BreakoutGameNodeJS.prototype.timestamp = function() {
	return (this.BreakoutGameNodeJS_now_var());
}
...
BreakoutGameNodeJS.prototype.toString = function() {
	...
	result += '\n\tnow = ' + this.BreakoutGameNodeJS_now_var;
