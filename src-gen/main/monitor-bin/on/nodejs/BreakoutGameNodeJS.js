...
BreakoutGameNodeJS.prototype.build = function(session) {
	...
	let BreakoutGame_SC_INIT = new StateJS.State('INIT', this._statemachine).entry(() => {
		...
		const createsent_log_174_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0C, xsize_172_var, ysize_173_var];
	...
	let BreakoutGame_SC_LAUNCH = new StateJS.State('LAUNCH', this._statemachine).entry(() => {
		...
		const timer_startsent_log_196_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x13, id_194_var, (((time_195_var >> 8) & 0xFF)), (((time_195_var >> 0) & 0xFF))];
		...
		const countdown_log_7_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_7_var, this.BreakoutGame_SC_LAUNCH_countdown_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', countdown_log_7_var, 5));
		this.drawScore();
		this.drawLives();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_197_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
	...
	let BreakoutGame_SC_PLAY = new StateJS.State('PLAY', this._statemachine).entry(() => {
		...
		const timer_startsent_log_205_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x13, id_203_var, (((time_204_var >> 8) & 0xFF)), (((time_204_var >> 0) & 0xFF))];
	...
	let BreakoutGame_SC_LOSTBALL = new StateJS.State('LOSTBALL', this._statemachine).entry(() => {
		...
		const timer_startsent_log_229_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x13, id_227_var, (((time_228_var >> 8) & 0xFF)), (((time_228_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_startsent_log_229_var, 7));
		const old_lives_5_var = this.BreakoutGame_lives_var;
		this.BreakoutGame_lives_var = this.BreakoutGame_lives_var - 1;
		const lives_log_5_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1C, old_lives_5_var, this.BreakoutGame_lives_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', lives_log_5_var, 5));
		this.eraseBall();
		this.erasePad();
		this.drawLives();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_230_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
	...
	let BreakoutGame_SC_NEXTLEVEL = new StateJS.State('NEXTLEVEL', this._statemachine).entry(() => {
		...
		const timer_startsent_log_233_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x13, id_231_var, (((time_232_var >> 8) & 0xFF)), (((time_232_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_startsent_log_233_var, 7));
		const old_level_6_var = this.BreakoutGame_level_var;
		this.BreakoutGame_level_var = this.BreakoutGame_level_var + 1;
		const level_log_6_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1D, old_level_6_var, this.BreakoutGame_level_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', level_log_6_var, 5));
		this.drawLevel();
		this.eraseBall();
		this.erasePad();
		if((this.BreakoutGame_level_var % 2) === 0 && this.BreakoutGame_padlen_var > 5 * this.BreakoutGame_SCALE_var) {
		const old_padlen_19_var = this.BreakoutGame_padlen_var;
		this.BreakoutGame_padlen_var = this.BreakoutGame_padlen_var - (4 * this.BreakoutGame_SCALE_var);
		const padlen_log_19_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x10, (((old_padlen_19_var >> 8) & 0xFF)), (((old_padlen_19_var >> 0) & 0xFF)), (((this.BreakoutGame_padlen_var >> 8) & 0xFF)), (((this.BreakoutGame_padlen_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', padlen_log_19_var, 7));
		...
		const dy_log_24_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_24_var >> 8) & 0xFF)), (((old_dy_24_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_24_var, 7));
		
		}
		this.drawLives();
		this.createBricks();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_234_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
	...
	let BreakoutGame_SC_GAMEOVER = new StateJS.State('GAMEOVER', this._statemachine).entry(() => {
		...
		const setColorsent_log_238_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_235_var, g_236_var, b_237_var];
		...
		const fillRectsent_log_243_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_239_var, y_240_var, width_241_var, height_242_var];
		...
		const setColorsent_log_247_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_244_var, g_245_var, b_246_var];
		...
		const fillRectsent_log_252_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_248_var, y_249_var, width_250_var, height_251_var];
		...
		const setBGColorsent_log_256_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x07, r_253_var, g_254_var, b_255_var];
		...
		const setColorsent_log_260_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_257_var, g_258_var, b_259_var];
		...
		const drawIntegersent_log_266_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0A, x_261_var, y_262_var, (((v_263_var >> 8) & 0xFF)), (((v_263_var >> 0) & 0xFF)), digits_264_var, scale_265_var];
		...
		const drawThingMLsent_log_269_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0B, x_267_var, y_268_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawThingMLsent_log_269_var, 6));
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_270_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
	...
	BreakoutGame_SC_INIT.to(BreakoutGame_SC_LAUNCH).on(Event.DisplayReady_DisplayMsgs).when((displayReady) => {
		...
		const displayReadyhandled_log_271_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', displayReadyhandled_log_271_var, 3));
		this.bus.emit('display', new Event.Clear_DisplayMsgs(this.name, 'display'));
		const clearsent_log_175_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x05];
		...
		const setColorsent_log_179_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_176_var, g_177_var, b_178_var];
		...
		const fillRectsent_log_184_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_180_var, y_181_var, width_182_var, height_183_var];
		...
		const setColorsent_log_188_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_185_var, g_186_var, b_187_var];
		...
		const fillRectsent_log_193_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_189_var, y_190_var, width_191_var, height_192_var];
	...
	this._statemachine.on(Event.DisplayReady).when((displayReady) => {
		...
		const displayReadylost_log_284_var = [Enum.LogType_ENUM.MESSAGE_LOST, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0F];
	...
	this._statemachine.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const timer_timeoutlost_log_283_var = [Enum.LogType_ENUM.MESSAGE_LOST, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x15, timer_timeout.id];
	...
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_277_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x09, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_277_var, 4));
	});
	BreakoutGame_SC_LOSTBALL.to(BreakoutGame_SC_GAMEOVER).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		return timer_timeout.port === 'clock' && timer_timeout.type === 'timer_timeout' && (timer_timeout.id === 0 && this.BreakoutGame_lives_var === 0);
	}).effect((timer_timeout) => {
		const timer_timeouthandled_log_278_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_278_var, 4));
	});
	BreakoutGame_SC_PLAY.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_276_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_276_var, 4));
		const old_bx_1_var = this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = this.BreakoutGame_bx_var + this.BreakoutGame_dx_var;
		const bx_log_1_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_1_var >> 8) & 0xFF)), (((old_bx_1_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_1_var, 7));
		const old_by_26_var = this.BreakoutGame_by_var;
		this.BreakoutGame_by_var = this.BreakoutGame_by_var + this.BreakoutGame_dy_var;
		const by_log_26_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_26_var >> 8) & 0xFF)), (((old_by_26_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_26_var, 7));
		...
		const dx_log_12_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_12_var >> 8) & 0xFF)), (((old_dx_12_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_12_var, 7));
		const old_bx_2_var = this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = 2 * wl_var - this.BreakoutGame_bx_var;
		const bx_log_2_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_2_var >> 8) & 0xFF)), (((old_bx_2_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_2_var, 7));
		...
		this.BreakoutGame_dx_var =  -this.BreakoutGame_dx_var;
		const dx_log_13_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_13_var >> 8) & 0xFF)), (((old_dx_13_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_13_var, 7));
		const old_bx_3_var = this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = 2 * wr_var - this.BreakoutGame_bx_var;
		const bx_log_3_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_3_var >> 8) & 0xFF)), (((old_bx_3_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_3_var, 7));
		this.incrementScore( -1);
		...
		const old_dy_21_var = this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const dy_log_21_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_21_var >> 8) & 0xFF)), (((old_dy_21_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_21_var, 7));
		const old_by_27_var = this.BreakoutGame_by_var;
		this.BreakoutGame_by_var = 2 * wt_var - this.BreakoutGame_by_var;
		const by_log_27_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_27_var >> 8) & 0xFF)), (((old_by_27_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_27_var, 7));
		this.incrementScore( -1);
		
		} else {
		if(this.BreakoutGame_by_var > wb_var) {
		this.bus.emit('game', new Event.LostBall_BreakoutGame(this.name, 'game'));
		const lostBallsent_log_206_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04, 0x00];
		...
		const lostBallsent_log_207_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x05, 0x00];
		...
		const old_dy_22_var = this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const dy_log_22_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_22_var >> 8) & 0xFF)), (((old_dy_22_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_22_var, 7));
		...
		const by_log_28_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_28_var >> 8) & 0xFF)), (((old_by_28_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
		...
		const dx_log_14_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_14_var >> 8) & 0xFF)), (((old_dx_14_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
		...
		if(collision_var) {
		const old_dy_23_var = this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
		const dy_log_23_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_23_var >> 8) & 0xFF)), (((old_dy_23_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_23_var, 7));
		this.incrementScore(10);
		if(this.bricksLeft() === 0) {
		this.bus.emit('game', new Event.NextLevel_BreakoutGame(this.name, 'game'));
		const nextLevelsent_log_208_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04, 0x01];
		...
		const nextLevelsent_log_209_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x05, 0x01];
		...
		const updateIAsent_log_214_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x03, 0x12, (((ballx_210_var >> 8) & 0xFF)), (((ballx_210_var >> 0) & 0xFF)), (((bally_211_var >> 8) & 0xFF)), (((bally_211_var >> 0) & 0xFF)), (((padx_212_var >> 8) & 0xFF)), (((padx_212_var >> 0) & 0xFF)), (((pady_213_var >> 8) & 0xFF)), (((pady_213_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', updateIAsent_log_214_var, 12));
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_215_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
		...
		const timer_startsent_log_218_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x13, id_216_var, (((time_217_var >> 8) & 0xFF)), (((time_217_var >> 0) & 0xFF))];
	...
	BreakoutGame_SC_NEXTLEVEL.to(BreakoutGame_SC_LAUNCH).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_273_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_273_var, 4));
	});
	BreakoutGame_SC_LAUNCH.to(BreakoutGame_SC_PLAY).on(Event.Timer_timeout_TimerMsgs).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_274_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x03, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_274_var, 4));
		this.drawCountDown(0);
		this.resetBall();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_202_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
	...
	BreakoutGame_SC_LAUNCH.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const timer_timeouthandled_log_275_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x02, timer_timeout.id];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', timer_timeouthandled_log_275_var, 4));
		const id_198_var = 0;
		...
		const timer_startsent_log_200_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x13, id_198_var, (((time_199_var >> 8) & 0xFF)), (((time_199_var >> 0) & 0xFF))];
		...
		const old_countdown_8_var = this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = this.BreakoutGame_SC_LAUNCH_countdown_var - 1;
		const countdown_log_8_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_8_var, this.BreakoutGame_SC_LAUNCH_countdown_var];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', countdown_log_8_var, 5));
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		const updatesent_log_201_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0E];
	...
	this._statemachine.on(Event.LostBall).when((lostBall) => {
		...
		const lostBalllost_log_285_var = [Enum.LogType_ENUM.MESSAGE_LOST, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04, 0x00];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_LOSTBALL).on(Event.LostBall_BreakoutGame).when((lostBall) => {
		...
		const lostBallhandled_log_281_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x05];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', lostBallhandled_log_281_var, 3));
		const id_219_var = 0;
		this.bus.emit('clock', new Event.Timer_cancel_TimerMsgs(this.name, 'clock', id_219_var));
		const timer_cancelsent_log_220_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x14, id_219_var];
	...
	this._statemachine.on(Event.NextLevel).when((nextLevel) => {
		...
		const nextLevellost_log_286_var = [Enum.LogType_ENUM.MESSAGE_LOST, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04, 0x01];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_NEXTLEVEL).on(Event.NextLevel_BreakoutGame).when((nextLevel) => {
		...
		const nextLevelhandled_log_282_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x06];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', nextLevelhandled_log_282_var, 3));
		const id_221_var = 0;
		this.bus.emit('clock', new Event.Timer_cancel_TimerMsgs(this.name, 'clock', id_221_var));
		const timer_cancelsent_log_222_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x14, id_221_var];
	...
	this._statemachine.on(Event.LostBall).when((lostBall) => {
		...
		const lostBalllost_log_287_var = [Enum.LogType_ENUM.MESSAGE_LOST, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x06, 0x00];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_LOSTBALL).on(Event.LostBall_BreakoutGame).when((lostBall) => {
		...
		const lostBallhandled_log_279_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x07];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', lostBallhandled_log_279_var, 3));
		const id_223_var = 0;
		this.bus.emit('clock', new Event.Timer_cancel_TimerMsgs(this.name, 'clock', id_223_var));
		const timer_cancelsent_log_224_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x14, id_223_var];
	...
	this._statemachine.on(Event.NextLevel).when((nextLevel) => {
		...
		const nextLevellost_log_288_var = [Enum.LogType_ENUM.MESSAGE_LOST, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x06, 0x01];
	...
	BreakoutGame_SC_PLAY.to(BreakoutGame_SC_NEXTLEVEL).on(Event.NextLevel_BreakoutGame).when((nextLevel) => {
		...
		const nextLevelhandled_log_280_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x08];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', nextLevelhandled_log_280_var, 3));
		const id_225_var = 0;
		this.bus.emit('clock', new Event.Timer_cancel_TimerMsgs(this.name, 'clock', id_225_var));
		const timer_cancelsent_log_226_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, 0x14, id_225_var];
	...
	this._statemachine.on(Event.Position).when((position) => {
		...
		const positionhandled_log_272_var = [Enum.LogType_ENUM.MESSAGE_HANDLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x00, (((position.x >> 8) & 0xFF)), (((position.x >> 0) & 0xFF)), (((position.y >> 8) & 0xFF)), (((position.y >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', positionhandled_log_272_var, 7));
		...
		const old_padx_4_var = this.BreakoutGame_padx_var;
		...
		const padx_log_4_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_padx_4_var >> 8) & 0xFF)), (((old_padx_4_var >> 0) & 0xFF)), (((this.BreakoutGame_padx_var >> 8) & 0xFF)), (((this.BreakoutGame_padx_var >> 0) & 0xFF))];
		this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', padx_log_4_var, 7));
	});
}
...
BreakoutGameNodeJS.prototype.initColors = function() {
	...
	const setBGColorsent_log_3_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x07, r_0_var, g_1_var, b_2_var];
	...
	const setColorsent_log_7_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_4_var, g_5_var, b_6_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', setColorsent_log_7_var, 7));
	const initColors_log0_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', initColors_log0_var, 3));
}

BreakoutGameNodeJS.prototype.resetBall = function() {
	const old_bx_0_var = this.BreakoutGame_bx_var;
	this.BreakoutGame_bx_var = this.BreakoutGame_padx_var - Math.trunc(this.BreakoutGame_br_var / this.BreakoutGame_SCALE_var);
	const bx_log_0_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_0_var >> 8) & 0xFF)), (((old_bx_0_var >> 0) & 0xFF)), (((this.BreakoutGame_bx_var >> 8) & 0xFF)), (((this.BreakoutGame_bx_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bx_log_0_var, 7));
	const old_by_25_var = this.BreakoutGame_by_var;
	this.BreakoutGame_by_var = this.BreakoutGame_pady_var - Math.trunc(this.BreakoutGame_br_var / this.BreakoutGame_SCALE_var);
	const by_log_25_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_25_var >> 8) & 0xFF)), (((old_by_25_var >> 0) & 0xFF)), (((this.BreakoutGame_by_var >> 8) & 0xFF)), (((this.BreakoutGame_by_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', by_log_25_var, 7));
	...
	const dx_log_11_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_11_var >> 8) & 0xFF)), (((old_dx_11_var >> 0) & 0xFF)), (((this.BreakoutGame_dx_var >> 8) & 0xFF)), (((this.BreakoutGame_dx_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dx_log_11_var, 7));
	if(this.BreakoutGame_dy_var > 0) {
	const old_dy_20_var = this.BreakoutGame_dy_var;
	this.BreakoutGame_dy_var =  -this.BreakoutGame_dy_var;
	const dy_log_20_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_20_var >> 8) & 0xFF)), (((old_dy_20_var >> 0) & 0xFF)), (((this.BreakoutGame_dy_var >> 8) & 0xFF)), (((this.BreakoutGame_dy_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', dy_log_20_var, 7));
	
	}
	const old_prevBX_29_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const prevBX_log_29_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_29_var >> 8) & 0xFF)), (((old_prevBX_29_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_29_var, 7));
	const old_prevBY_15_var = this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const prevBY_log_15_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_15_var >> 8) & 0xFF)), (((old_prevBY_15_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBY_log_15_var, 7));
	const resetBall_log1_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x02];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', resetBall_log1_var, 3));
}
...
BreakoutGameNodeJS.prototype.eraseBall = function() {
	...
	const setColorsent_log_11_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_8_var, g_9_var, b_10_var];
	...
	const fillRectsent_log_16_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_12_var, y_13_var, width_14_var, height_15_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_16_var, 8));
	
	}
	const old_prevBX_30_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const prevBX_log_30_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_30_var >> 8) & 0xFF)), (((old_prevBX_30_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_30_var, 7));
	const old_prevBY_16_var = this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const prevBY_log_16_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_16_var >> 8) & 0xFF)), (((old_prevBY_16_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBY_log_16_var, 7));
	const eraseBall_log2_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x03];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', eraseBall_log2_var, 3));
}

BreakoutGameNodeJS.prototype.drawBall = function() {
	let bs_var = Math.trunc((this.BreakoutGame_br_var * 2) / this.BreakoutGame_SCALE_var);
	this.eraseBall();
	const old_prevBX_31_var = this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var = Math.trunc((this.BreakoutGame_bx_var - this.BreakoutGame_br_var) / this.BreakoutGame_SCALE_var);
	const prevBX_log_31_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_31_var >> 8) & 0xFF)), (((old_prevBX_31_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevBX_log_31_var, 7));
	...
	const prevBY_log_17_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_17_var >> 8) & 0xFF)), (((old_prevBY_17_var >> 0) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevBY_var >> 0) & 0xFF))];
	...
	const setColorsent_log_20_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_17_var, g_18_var, b_19_var];
	...
	const fillRectsent_log_25_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_21_var, y_22_var, width_23_var, height_24_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_25_var, 8));
	const drawBall_log3_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x04];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawBall_log3_var, 3));
}
...
BreakoutGameNodeJS.prototype.erasePad = function() {
	...
	const setColorsent_log_29_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_26_var, g_27_var, b_28_var];
	...
	const fillRectsent_log_34_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_30_var, y_31_var, width_32_var, height_33_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_34_var, 8));
	
	}
	const erasePad_log4_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x05];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', erasePad_log4_var, 3));
}

BreakoutGameNodeJS.prototype.drawPad = function() {
	let ps_var = Math.trunc(this.BreakoutGame_padlen_var / this.BreakoutGame_SCALE_var);
	this.erasePad();
	const old_prevPX_32_var = this.BreakoutGame_prevPX_var;
	...
	const prevPX_log_32_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x16, (((old_prevPX_32_var >> 8) & 0xFF)), (((old_prevPX_32_var >> 0) & 0xFF)), (((this.BreakoutGame_prevPX_var >> 8) & 0xFF)), (((this.BreakoutGame_prevPX_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevPX_log_32_var, 7));
	const old_prevPY_18_var = this.BreakoutGame_prevPY_var;
	this.BreakoutGame_prevPY_var = Math.trunc(this.BreakoutGame_pady_var / this.BreakoutGame_SCALE_var);
	const prevPY_log_18_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x17, (((old_prevPY_18_var >> 8) & 0xFF)), (((old_prevPY_18_var >> 0) & 0xFF)), (((this.BreakoutGame_prevPY_var >> 8) & 0xFF)), (((this.BreakoutGame_prevPY_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', prevPY_log_18_var, 7));
	...
	const setColorsent_log_38_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_35_var, g_36_var, b_37_var];
	...
	const fillRectsent_log_43_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_39_var, y_40_var, width_41_var, height_42_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_43_var, 8));
	const drawPad_log5_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x06];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawPad_log5_var, 3));
}
...
BreakoutGameNodeJS.prototype.drawCountDown = function(BreakoutGame_drawCountDown_c_var) {
	...
	const setColorsent_log_47_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_44_var, g_45_var, b_46_var];
	...
	const setColorsent_log_51_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_48_var, g_49_var, b_50_var];
	...
	const setBGColorsent_log_55_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x07, r_52_var, g_53_var, b_54_var];
	...
	const drawIntegersent_log_61_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0A, x_56_var, y_57_var, (((v_58_var >> 8) & 0xFF)), (((v_58_var >> 0) & 0xFF)), digits_59_var, scale_60_var];
	...
	const setColorsent_log_65_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_62_var, g_63_var, b_64_var];
	...
	const fillRectsent_log_70_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_66_var, y_67_var, width_68_var, height_69_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_70_var, 8));
	
	}
	const drawCountDown_log6_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x07, (((BreakoutGame_drawCountDown_c_var >> 8) & 0xFF)), (((BreakoutGame_drawCountDown_c_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawCountDown_log6_var, 5));
}
...
BreakoutGameNodeJS.prototype.drawWalls = function() {
	...
	const setColorsent_log_74_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_71_var, g_72_var, b_73_var];
	...
	const fillRectsent_log_79_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_75_var, y_76_var, width_77_var, height_78_var];
	...
	const fillRectsent_log_84_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_80_var, y_81_var, width_82_var, height_83_var];
	...
	const fillRectsent_log_89_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_85_var, y_86_var, width_87_var, height_88_var];
	...
	const fillRectsent_log_94_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_90_var, y_91_var, width_92_var, height_93_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_94_var, 8));
	const drawWalls_log7_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x08];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawWalls_log7_var, 3));
}
...
BreakoutGameNodeJS.prototype.bitIsSet = function(BreakoutGame_bitIsSet_variable_var, BreakoutGame_bitIsSet_bit_var) {
	...
	const bitIsSet_log8_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x09, BreakoutGame_bitIsSet_variable_var, BreakoutGame_bitIsSet_bit_var, return_0_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bitIsSet_log8_var, 6));
	return return_0_var;
}
...
BreakoutGameNodeJS.prototype.createBricks = function() {
	...
	const createBricks_log9_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0A];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', createBricks_log9_var, 3));
}
...
BreakoutGameNodeJS.prototype.bricksLeft = function() {
	...
	const bricksLeft_log10_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, return_3_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', bricksLeft_log10_var, 4));
	return return_3_var;
}
...
BreakoutGameNodeJS.prototype.drawBrick = function(BreakoutGame_drawBrick_x_var, BreakoutGame_drawBrick_y_var) {
	...
	const setColorsent_log_98_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_95_var, g_96_var, b_97_var];
	...
	const fillRectsent_log_103_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_99_var, y_100_var, width_101_var, height_102_var];
	...
	const setColorsent_log_107_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_104_var, g_105_var, b_106_var];
	...
	const drawRectsent_log_112_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x08, x_108_var, y_109_var, width_110_var, height_111_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawRectsent_log_112_var, 8));
	const drawBrick_log11_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, BreakoutGame_drawBrick_x_var, BreakoutGame_drawBrick_y_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawBrick_log11_var, 5));
}
...
BreakoutGameNodeJS.prototype.removeBrick = function(BreakoutGame_removeBrick_x_var, BreakoutGame_removeBrick_y_var) {
	...
	const setColorsent_log_116_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_113_var, g_114_var, b_115_var];
	...
	const fillRectsent_log_121_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_117_var, y_118_var, width_119_var, height_120_var];
	...
	const removeBrick_log12_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, BreakoutGame_removeBrick_x_var, BreakoutGame_removeBrick_y_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', removeBrick_log12_var, 5));
}
...
BreakoutGameNodeJS.prototype.collideBrick = function(BreakoutGame_collideBrick_xpos_var, BreakoutGame_collideBrick_ypos_var) {
	...
	const return_3_var = result_var;
	const collideBrick_log13_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((BreakoutGame_collideBrick_xpos_var >> 8) & 0xFF)), (((BreakoutGame_collideBrick_xpos_var >> 0) & 0xFF)), (((BreakoutGame_collideBrick_ypos_var >> 8) & 0xFF)), (((BreakoutGame_collideBrick_ypos_var >> 0) & 0xFF)), return_3_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', collideBrick_log13_var, 8));
	return return_3_var;
}
...
BreakoutGameNodeJS.prototype.drawLevel = function() {
	...
	const setColorsent_log_125_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_122_var, g_123_var, b_124_var];
	...
	const setBGColorsent_log_129_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x07, r_126_var, g_127_var, b_128_var];
	...
	const setColorsent_log_133_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_130_var, g_131_var, b_132_var];
	...
	const drawIntegersent_log_139_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0A, x_134_var, y_135_var, (((v_136_var >> 8) & 0xFF)), (((v_136_var >> 0) & 0xFF)), digits_137_var, scale_138_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawIntegersent_log_139_var, 10));
	const drawLevel_log14_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x0F];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawLevel_log14_var, 3));
}
...
BreakoutGameNodeJS.prototype.incrementScore = function(BreakoutGame_incrementScore_diff_var) {
	...
	const score_log_9_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_9_var >> 8) & 0xFF)), (((old_score_9_var >> 0) & 0xFF)), (((this.BreakoutGame_score_var >> 8) & 0xFF)), (((this.BreakoutGame_score_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', score_log_9_var, 7));
	if(this.BreakoutGame_score_var < 0) {
	const old_score_10_var = this.BreakoutGame_score_var;
	this.BreakoutGame_score_var = 0;
	const score_log_10_var = [Enum.LogType_ENUM.PROPERTY_CHANGED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_10_var >> 8) & 0xFF)), (((old_score_10_var >> 0) & 0xFF)), (((this.BreakoutGame_score_var >> 8) & 0xFF)), (((this.BreakoutGame_score_var >> 0) & 0xFF))];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', score_log_10_var, 7));
	
	}
	this.drawScore();
	const incrementScore_log15_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x10, BreakoutGame_incrementScore_diff_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', incrementScore_log15_var, 4));
}
...
BreakoutGameNodeJS.prototype.drawScore = function() {
	...
	const setColorsent_log_143_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_140_var, g_141_var, b_142_var];
	...
	const setBGColorsent_log_147_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x07, r_144_var, g_145_var, b_146_var];
	...
	const drawIntegersent_log_153_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x0A, x_148_var, y_149_var, (((v_150_var >> 8) & 0xFF)), (((v_150_var >> 0) & 0xFF)), digits_151_var, scale_152_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawIntegersent_log_153_var, 10));
	const drawScore_log16_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x11];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawScore_log16_var, 3));
}
...
BreakoutGameNodeJS.prototype.drawLives = function() {
	...
	const setColorsent_log_157_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_154_var, g_155_var, b_156_var];
	...
	const fillRectsent_log_162_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_158_var, y_159_var, width_160_var, height_161_var];
	...
	const setColorsent_log_166_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x06, r_163_var, g_164_var, b_165_var];
	...
	const fillRectsent_log_171_var = [Enum.LogType_ENUM.MESSAGE_SENT, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x09, x_167_var, y_168_var, width_169_var, height_170_var];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', fillRectsent_log_171_var, 8));
	i_var = i_var + 1;
	
	}
	const drawLives_log17_var = [Enum.LogType_ENUM.FUNCTION_CALLED, this.WithBinaryLog_DEBUG_BIN_ID_var, 0x12];
	this.bus.emit('log', new Event.Log_LogMsgs(this.name, 'log', drawLives_log17_var, 3));
}
