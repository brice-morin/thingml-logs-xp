...
BreakoutGamePosix_send_log_log(_instance, initColors_log0, 3);
}
...
uint8_t bx_log_19[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_19 >> 8) & 0xFF)), (((old_bx_19 >> 0) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_19, 7);
...
uint8_t by_log_29[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_29 >> 8) & 0xFF)), (((old_by_29 >> 0) & 0xFF)), (((_instance->BreakoutGame_by_var >> 8) & 0xFF)), (((_instance->BreakoutGame_by_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_29, 7);
...
uint8_t dx_log_23[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_23 >> 8) & 0xFF)), (((old_dx_23 >> 0) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_23, 7);
if(_instance->BreakoutGame_dy_var > 0) {
int16_t old_dy_0 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
uint8_t dy_log_0[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_0 >> 8) & 0xFF)), (((old_dy_0 >> 0) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_0, 7);

}
int16_t old_prevBX_6 = _instance->BreakoutGame_prevBX_var;
_instance->BreakoutGame_prevBX_var =  -1;
uint8_t prevBX_log_6[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_6 >> 8) & 0xFF)), (((old_prevBX_6 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevBX_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevBX_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBX_log_6, 7);
int16_t old_prevBY_16 = _instance->BreakoutGame_prevBY_var;
_instance->BreakoutGame_prevBY_var =  -1;
uint8_t prevBY_log_16[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_16 >> 8) & 0xFF)), (((old_prevBY_16 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevBY_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevBY_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBY_log_16, 7);
uint8_t resetBall_log1[3] = {LOGTYPE_FUNCTION_CALLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x02};
BreakoutGamePosix_send_log_log(_instance, resetBall_log1, 3);
}
...
int16_t old_prevBX_7 = _instance->BreakoutGame_prevBX_var;
_instance->BreakoutGame_prevBX_var =  -1;
uint8_t prevBX_log_7[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_7 >> 8) & 0xFF)), (((old_prevBX_7 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevBX_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevBX_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBX_log_7, 7);
int16_t old_prevBY_17 = _instance->BreakoutGame_prevBY_var;
_instance->BreakoutGame_prevBY_var =  -1;
uint8_t prevBY_log_17[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_17 >> 8) & 0xFF)), (((old_prevBY_17 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevBY_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevBY_var >> 0) & 0xFF))};
...
BreakoutGamePosix_send_log_log(_instance, eraseBall_log2, 3);
}
// Definition of function drawBall
void f_BreakoutGamePosix_drawBall(struct BreakoutGamePosix_Instance *_instance) {
int16_t bs = (_instance->BreakoutGame_br_var * 2) / _instance->BreakoutGame_SCALE_var;
f_BreakoutGamePosix_eraseBall(_instance);
int16_t old_prevBX_8 = _instance->BreakoutGame_prevBX_var;
...
uint8_t prevBX_log_8[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_8 >> 8) & 0xFF)), (((old_prevBX_8 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevBX_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevBX_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBX_log_8, 7);
...
uint8_t prevBY_log_18[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_18 >> 8) & 0xFF)), (((old_prevBY_18 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevBY_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevBY_var >> 0) & 0xFF))};
...
BreakoutGamePosix_send_log_log(_instance, drawBall_log3, 3);
}
...
BreakoutGamePosix_send_log_log(_instance, erasePad_log4, 3);
}
// Definition of function drawPad
void f_BreakoutGamePosix_drawPad(struct BreakoutGamePosix_Instance *_instance) {
int16_t ps = _instance->BreakoutGame_padlen_var / _instance->BreakoutGame_SCALE_var;
f_BreakoutGamePosix_erasePad(_instance);
int16_t old_prevPX_9 = _instance->BreakoutGame_prevPX_var;
...
uint8_t prevPX_log_9[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x16, (((old_prevPX_9 >> 8) & 0xFF)), (((old_prevPX_9 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevPX_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevPX_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevPX_log_9, 7);
int16_t old_prevPY_27 = _instance->BreakoutGame_prevPY_var;
_instance->BreakoutGame_prevPY_var = _instance->BreakoutGame_pady_var / _instance->BreakoutGame_SCALE_var;
uint8_t prevPY_log_27[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x17, (((old_prevPY_27 >> 8) & 0xFF)), (((old_prevPY_27 >> 0) & 0xFF)), (((_instance->BreakoutGame_prevPY_var >> 8) & 0xFF)), (((_instance->BreakoutGame_prevPY_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevPY_log_27, 7);
...
BreakoutGamePosix_send_log_log(_instance, drawPad_log5, 3);
}
...
BreakoutGamePosix_send_log_log(_instance, drawCountDown_log6, 5);
}
...
BreakoutGamePosix_send_log_log(_instance, drawWalls_log7, 3);
}
...
BreakoutGamePosix_send_log_log(_instance, bitIsSet_log8, 6);
return return_0;
}
...
BreakoutGamePosix_send_log_log(_instance, createBricks_log9, 3);
}
...
BreakoutGamePosix_send_log_log(_instance, bricksLeft_log10, 4);
return return_3;
}
...
BreakoutGamePosix_send_log_log(_instance, drawBrick_log11, 5);
}
...
BreakoutGamePosix_send_log_log(_instance, removeBrick_log12, 5);
}
...
BreakoutGamePosix_send_log_log(_instance, collideBrick_log13, 8);
return return_3;
}
...
BreakoutGamePosix_send_log_log(_instance, drawLevel_log14, 3);
}
// Definition of function incrementScore
void f_BreakoutGamePosix_incrementScore(struct BreakoutGamePosix_Instance *_instance, int8_t diff) {
int16_t old_score_10 = _instance->BreakoutGame_score_var;
_instance->BreakoutGame_score_var = _instance->BreakoutGame_score_var + diff;
uint8_t score_log_10[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_10 >> 8) & 0xFF)), (((old_score_10 >> 0) & 0xFF)), (((_instance->BreakoutGame_score_var >> 8) & 0xFF)), (((_instance->BreakoutGame_score_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, score_log_10, 7);
...
uint8_t score_log_11[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_11 >> 8) & 0xFF)), (((old_score_11 >> 0) & 0xFF)), (((_instance->BreakoutGame_score_var >> 8) & 0xFF)), (((_instance->BreakoutGame_score_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, score_log_11, 7);
...
BreakoutGamePosix_send_log_log(_instance, incrementScore_log15, 4);
}
...
BreakoutGamePosix_send_log_log(_instance, drawScore_log16, 3);
}
...
BreakoutGamePosix_send_log_log(_instance, drawLives_log17, 3);
}
...
uint8_t old_countdown_12 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
_instance->BreakoutGame_SC_LAUNCH_countdown_var = 3;
uint8_t countdown_log_12[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_12, _instance->BreakoutGame_SC_LAUNCH_countdown_var};
BreakoutGamePosix_send_log_log(_instance, countdown_log_12, 5);
f_BreakoutGamePosix_drawScore(_instance);
...
uint8_t old_lives_28 = _instance->BreakoutGame_lives_var;
_instance->BreakoutGame_lives_var = _instance->BreakoutGame_lives_var - 1;
uint8_t lives_log_28[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1C, old_lives_28, _instance->BreakoutGame_lives_var};
BreakoutGamePosix_send_log_log(_instance, lives_log_28, 5);
f_BreakoutGamePosix_eraseBall(_instance);
f_BreakoutGamePosix_erasePad(_instance);
f_BreakoutGamePosix_drawLives(_instance);
BreakoutGamePosix_send_display_update(_instance);
...
uint8_t old_level_15 = _instance->BreakoutGame_level_var;
_instance->BreakoutGame_level_var = _instance->BreakoutGame_level_var + 1;
uint8_t level_log_15[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1D, old_level_15, _instance->BreakoutGame_level_var};
BreakoutGamePosix_send_log_log(_instance, level_log_15, 5);
...
int16_t old_padlen_14 = _instance->BreakoutGame_padlen_var;
_instance->BreakoutGame_padlen_var = _instance->BreakoutGame_padlen_var - (4 * _instance->BreakoutGame_SCALE_var);
uint8_t padlen_log_14[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x10, (((old_padlen_14 >> 8) & 0xFF)), (((old_padlen_14 >> 0) & 0xFF)), (((_instance->BreakoutGame_padlen_var >> 8) & 0xFF)), (((_instance->BreakoutGame_padlen_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, padlen_log_14, 7);

}
if((_instance->BreakoutGame_level_var % 2) == 1) {
int16_t old_dy_4 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var = (_instance->BreakoutGame_dy_var * 3) / 2;
uint8_t dy_log_4[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_4 >> 8) & 0xFF)), (((old_dy_4 >> 0) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_4, 7);
...
uint8_t timer_timeouthandled_log_272[4] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x03, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_272, 4);
...
uint8_t timer_timeouthandled_log_273[4] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x02, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_273, 4);
uint8_t id_198 = 0;
...
uint8_t countdown_log_13[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_13, _instance->BreakoutGame_SC_LAUNCH_countdown_var};
BreakoutGamePosix_send_log_log(_instance, countdown_log_13, 5);
BreakoutGamePosix_send_display_update(_instance);
...
uint8_t timer_timeouthandled_log_277[4] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x04, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_277, 4);
...
uint8_t bx_log_20[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_20 >> 8) & 0xFF)), (((old_bx_20 >> 0) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_20, 7);
...
uint8_t by_log_30[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_30 >> 8) & 0xFF)), (((old_by_30 >> 0) & 0xFF)), (((_instance->BreakoutGame_by_var >> 8) & 0xFF)), (((_instance->BreakoutGame_by_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_30, 7);
...
uint8_t dx_log_24[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_24 >> 8) & 0xFF)), (((old_dx_24 >> 0) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_24, 7);
int16_t old_bx_21 = _instance->BreakoutGame_bx_var;
_instance->BreakoutGame_bx_var = 2 * wl - _instance->BreakoutGame_bx_var;
uint8_t bx_log_21[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_21 >> 8) & 0xFF)), (((old_bx_21 >> 0) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_21, 7);
...
_instance->BreakoutGame_dx_var =  -_instance->BreakoutGame_dx_var;
uint8_t dx_log_25[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_25 >> 8) & 0xFF)), (((old_dx_25 >> 0) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_25, 7);
int16_t old_bx_22 = _instance->BreakoutGame_bx_var;
_instance->BreakoutGame_bx_var = 2 * wr - _instance->BreakoutGame_bx_var;
uint8_t bx_log_22[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_22 >> 8) & 0xFF)), (((old_bx_22 >> 0) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_bx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_22, 7);
f_BreakoutGamePosix_incrementScore(_instance,  -1);
...
int16_t old_dy_1 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
uint8_t dy_log_1[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_1 >> 8) & 0xFF)), (((old_dy_1 >> 0) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_1, 7);
int16_t old_by_31 = _instance->BreakoutGame_by_var;
_instance->BreakoutGame_by_var = 2 * wt - _instance->BreakoutGame_by_var;
uint8_t by_log_31[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_31 >> 8) & 0xFF)), (((old_by_31 >> 0) & 0xFF)), (((_instance->BreakoutGame_by_var >> 8) & 0xFF)), (((_instance->BreakoutGame_by_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_31, 7);
f_BreakoutGamePosix_incrementScore(_instance,  -1);
...
int16_t old_dy_2 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
uint8_t dy_log_2[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_2 >> 8) & 0xFF)), (((old_dy_2 >> 0) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_2, 7);
...
uint8_t by_log_32[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_32 >> 8) & 0xFF)), (((old_by_32 >> 0) & 0xFF)), (((_instance->BreakoutGame_by_var >> 8) & 0xFF)), (((_instance->BreakoutGame_by_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_32, 7);
int16_t old_dx_26 = _instance->BreakoutGame_dx_var;
...
uint8_t dx_log_26[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_26 >> 8) & 0xFF)), (((old_dx_26 >> 0) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_26, 7);
...
if(collision) {
int16_t old_dy_3 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
uint8_t dy_log_3[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_3 >> 8) & 0xFF)), (((old_dy_3 >> 0) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 8) & 0xFF)), (((_instance->BreakoutGame_dy_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_3, 7);
...
uint8_t timer_timeouthandled_log_274[4] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x09, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_274, 4);
...
uint8_t timer_timeouthandled_log_275[4] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_275, 4);
...
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LAUNCH_STATE;
uint8_t timer_timeouthandled_log_276[4] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_276, 4);
BreakoutGame_SC_OnEntry(BREAKOUTGAME_SC_LAUNCH_STATE, _instance);
BreakoutGame_SC_State_event_consumed = 1;
}
}
...
//Session list: 
if (1) {
uint8_t positionhandled_log_271[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x00, (((x >> 8) & 0xFF)), (((x >> 0) & 0xFF)), (((y >> 8) & 0xFF)), (((y >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, positionhandled_log_271, 7);
int32_t center = (_instance->BreakoutGame_RIGHT_var - _instance->BreakoutGame_LEFT_var - _instance->BreakoutGame_padlen_var);
center = x * center;
center = center / 200;
int16_t old_padx_5 = _instance->BreakoutGame_padx_var;
...
uint8_t padx_log_5[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_padx_5 >> 8) & 0xFF)), (((old_padx_5 >> 0) & 0xFF)), (((_instance->BreakoutGame_padx_var >> 8) & 0xFF)), (((_instance->BreakoutGame_padx_var >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, padx_log_5, 7);
BreakoutGame_SC_State_event_consumed = 1;
}
}
...
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LAUNCH_STATE;
uint8_t displayReadyhandled_log_280[3] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01};
BreakoutGamePosix_send_log_log(_instance, displayReadyhandled_log_280, 3);
...
uint8_t nextLevelhandled_log_282[3] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x06};
BreakoutGamePosix_send_log_log(_instance, nextLevelhandled_log_282, 3);
uint8_t id_221 = 0;
...
uint8_t lostBallhandled_log_281[3] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x05};
BreakoutGamePosix_send_log_log(_instance, lostBallhandled_log_281, 3);
uint8_t id_219 = 0;
...
BreakoutGame_SC_OnExit(BREAKOUTGAME_SC_PLAY_STATE, _instance);
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_NEXTLEVEL_STATE;
uint8_t nextLevelhandled_log_279[3] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x08};
BreakoutGamePosix_send_log_log(_instance, nextLevelhandled_log_279, 3);
uint8_t id_225 = 0;
...
BreakoutGamePosix_send_log_log(_instance, lostBallhandled_log_278, 3);
uint8_t id_223 = 0;
