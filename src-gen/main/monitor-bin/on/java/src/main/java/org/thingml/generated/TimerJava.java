...
Handler h1258801872 = new Handler();
h1258801872.from(state_TimerJava_SoftTimer_default);
h1258801872.event(timer_startType);
h1258801872.guard((Event e)->{
...
h1258801872.port(timer_port);
h1258801872.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
startTimer((int) (timer_start.id), (int) (timer_start.time));
});

Handler h1720332964 = new Handler();
h1720332964.from(state_TimerJava_SoftTimer_default);
h1720332964.event(timer_startType);
h1720332964.guard((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
return timer_start.time == 0;
});

h1720332964.port(timer_port);
h1720332964.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
