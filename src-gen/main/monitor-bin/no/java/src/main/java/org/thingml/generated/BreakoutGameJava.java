...
sendSetColor_via_display((int) (BreakoutGame_fgcolor_var[(int)(0)]), (int) (BreakoutGame_fgcolor_var[(int)(1)]), (int) (BreakoutGame_fgcolor_var[(int)(2)]));
sendFillRect_via_display((int) (9), (int) (31), (int) (140), (int) (50));
sendSetBGColor_via_display((int) (BreakoutGame_fgcolor_var[(int)(0)]), (int) (BreakoutGame_fgcolor_var[(int)(1)]), (int) (BreakoutGame_fgcolor_var[(int)(2)]));
...
Transition h793319856 = new Transition();
h793319856.from(state_BreakoutGame_SC_INIT).to(state_BreakoutGame_SC_LAUNCH);
h793319856.event(displayReadyType);
h793319856.port(display_port);
h793319856.action((Event e)->{
sendClear_via_display();
initColors();
sendSetColor_via_display((int) (BreakoutGame_bgcolor_var[(int)(0)]), (int) (BreakoutGame_bgcolor_var[(int)(1)]), (int) (BreakoutGame_bgcolor_var[(int)(2)]));
...
Handler h94748968 = new Handler();
h94748968.from(state_BreakoutGame_SC_LAUNCH);
h94748968.event(timer_timeoutType);
h94748968.guard((Event e)->{
...
h94748968.port(clock_port);
h94748968.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
sendTimer_start_via_clock((int) (0), (int) (getBreakoutGame_period_var()));
drawPad();
...
Transition h1096411163 = new Transition();
h1096411163.from(state_BreakoutGame_SC_LAUNCH).to(state_BreakoutGame_SC_PLAY);
h1096411163.event(timer_timeoutType);
h1096411163.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_SC_LAUNCH_countdown_var() == 0;
});

h1096411163.port(clock_port);
h1096411163.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
drawCountDown((int) (0));
resetBall();
sendUpdate_via_display();
...
Handler h949314262 = new Handler();
h949314262.from(state_BreakoutGame_SC_PLAY);
h949314262.event(timer_timeoutType);
h949314262.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h949314262.port(clock_port);
h949314262.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
...
Transition h1275011461 = new Transition();
h1275011461.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h1275011461.event(lostBallType);
h1275011461.port(game_port);
h1275011461.action((Event e)->{
sendTimer_cancel_via_clock((int) (0));
});

Transition h1186989416 = new Transition();
h1186989416.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h1186989416.event(nextLevelType);
h1186989416.port(game_port);
h1186989416.action((Event e)->{
sendTimer_cancel_via_clock((int) (0));
});

Transition h488669101 = new Transition();
h488669101.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h488669101.event(lostBallType);
h488669101.port(pro_game_port);
h488669101.action((Event e)->{
sendTimer_cancel_via_clock((int) (0));
});

Transition h1502882632 = new Transition();
h1502882632.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h1502882632.event(nextLevelType);
h1502882632.port(pro_game_port);
h1502882632.action((Event e)->{
sendTimer_cancel_via_clock((int) (0));
});

Transition h1418102907 = new Transition();
h1418102907.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_LAUNCH);
h1418102907.event(timer_timeoutType);
h1418102907.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() > 0;
});

h1418102907.port(clock_port);
Transition h1137667747 = new Transition();
h1137667747.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_GAMEOVER);
h1137667747.event(timer_timeoutType);
h1137667747.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() == 0;
});

h1137667747.port(clock_port);
Transition h1432403167 = new Transition();
h1432403167.from(state_BreakoutGame_SC_NEXTLEVEL).to(state_BreakoutGame_SC_LAUNCH);
h1432403167.event(timer_timeoutType);
h1432403167.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h1432403167.port(clock_port);
final CompositeState state_BreakoutGame_SC = new CompositeState("SC");
state_BreakoutGame_SC.onEntry(()->{
});
Handler h643587433 = new Handler();
h643587433.from(state_BreakoutGame_SC);
h643587433.event(positionType);
h643587433.port(controller_port);
h643587433.action((Event e)->{
...
sendSetBGColor_via_display((int) (BreakoutGame_bgcolor_var[(int)(0)]), (int) (BreakoutGame_bgcolor_var[(int)(1)]), (int) (BreakoutGame_bgcolor_var[(int)(2)]));
sendSetColor_via_display((int) (BreakoutGame_fgcolor_var[(int)(0)]), (int) (BreakoutGame_fgcolor_var[(int)(1)]), (int) (BreakoutGame_fgcolor_var[(int)(2)]));
}
 void resetBall() {
