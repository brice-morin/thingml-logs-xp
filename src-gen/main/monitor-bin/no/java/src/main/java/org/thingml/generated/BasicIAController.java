...
Transition h1139801481 = new Transition();
h1139801481.from(state_BasicIAController_SC_Following).to(state_BasicIAController_SC_Following);
h1139801481.event(updateIAType);
h1139801481.port(game_port);
h1139801481.action((Event e)->{
