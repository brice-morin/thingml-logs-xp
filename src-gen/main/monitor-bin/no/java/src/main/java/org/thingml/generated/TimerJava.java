...
Handler h1605834811 = new Handler();
h1605834811.from(state_TimerJava_SoftTimer_default);
h1605834811.event(timer_startType);
h1605834811.guard((Event e)->{
...
h1605834811.port(timer_port);
h1605834811.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
startTimer((int) (timer_start.id), (int) (timer_start.time));
});

Handler h1441577726 = new Handler();
h1441577726.from(state_TimerJava_SoftTimer_default);
h1441577726.event(timer_startType);
h1441577726.guard((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
return timer_start.time == 0;
});

h1441577726.port(timer_port);
h1441577726.action((Event e)->{
final Timer_startMessageType.Timer_startMessage timer_start = (Timer_startMessageType.Timer_startMessage) e;
