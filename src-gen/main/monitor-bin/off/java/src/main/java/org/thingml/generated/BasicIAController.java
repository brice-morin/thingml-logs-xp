...
Transition h162821120 = new Transition();
h162821120.from(state_BasicIAController_SC_Following).to(state_BasicIAController_SC_Following);
h162821120.event(updateIAType);
h162821120.port(game_port);
h162821120.action((Event e)->{
