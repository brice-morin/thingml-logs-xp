...
void f_BreakoutGamePosix_resetBall(struct BreakoutGamePosix_Instance *_instance) {
int16_t old_bx_14 = _instance->BreakoutGame_bx_var;
...
int16_t new_bx_14 = _instance->BreakoutGame_bx_var;
uint8_t bx_log_14[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_14 >> 8) & 0xFF)), (((old_bx_14 >> 0) & 0xFF)), (((new_bx_14 >> 8) & 0xFF)), (((new_bx_14 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_14, 7);
int16_t old_by_0 = _instance->BreakoutGame_by_var;
...
int16_t new_by_0 = _instance->BreakoutGame_by_var;
uint8_t by_log_0[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_0 >> 8) & 0xFF)), (((old_by_0 >> 0) & 0xFF)), (((new_by_0 >> 8) & 0xFF)), (((new_by_0 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_0, 7);
int16_t old_dx_27 = _instance->BreakoutGame_dx_var;
...
int16_t new_dx_27 = _instance->BreakoutGame_dx_var;
uint8_t dx_log_27[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_27 >> 8) & 0xFF)), (((old_dx_27 >> 0) & 0xFF)), (((new_dx_27 >> 8) & 0xFF)), (((new_dx_27 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_27, 7);
if(_instance->BreakoutGame_dy_var > 0) {
int16_t old_dy_18 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
int16_t new_dy_18 = _instance->BreakoutGame_dy_var;
uint8_t dy_log_18[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_18 >> 8) & 0xFF)), (((old_dy_18 >> 0) & 0xFF)), (((new_dy_18 >> 8) & 0xFF)), (((new_dy_18 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_18, 7);

}
int16_t old_prevBX_23 = _instance->BreakoutGame_prevBX_var;
_instance->BreakoutGame_prevBX_var =  -1;
int16_t new_prevBX_23 = _instance->BreakoutGame_prevBX_var;
uint8_t prevBX_log_23[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x11, (((old_prevBX_23 >> 8) & 0xFF)), (((old_prevBX_23 >> 0) & 0xFF)), (((new_prevBX_23 >> 8) & 0xFF)), (((new_prevBX_23 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBX_log_23, 7);
int16_t old_prevBY_6 = _instance->BreakoutGame_prevBY_var;
_instance->BreakoutGame_prevBY_var =  -1;
int16_t new_prevBY_6 = _instance->BreakoutGame_prevBY_var;
uint8_t prevBY_log_6[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_6 >> 8) & 0xFF)), (((old_prevBY_6 >> 0) & 0xFF)), (((new_prevBY_6 >> 8) & 0xFF)), (((new_prevBY_6 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBY_log_6, 7);
...
int16_t old_prevBY_7 = _instance->BreakoutGame_prevBY_var;
_instance->BreakoutGame_prevBY_var =  -1;
int16_t new_prevBY_7 = _instance->BreakoutGame_prevBY_var;
uint8_t prevBY_log_7[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_7 >> 8) & 0xFF)), (((old_prevBY_7 >> 0) & 0xFF)), (((new_prevBY_7 >> 8) & 0xFF)), (((new_prevBY_7 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBY_log_7, 7);
...
int16_t old_prevBY_8 = _instance->BreakoutGame_prevBY_var;
...
int16_t new_prevBY_8 = _instance->BreakoutGame_prevBY_var;
uint8_t prevBY_log_8[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x12, (((old_prevBY_8 >> 8) & 0xFF)), (((old_prevBY_8 >> 0) & 0xFF)), (((new_prevBY_8 >> 8) & 0xFF)), (((new_prevBY_8 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevBY_log_8, 7);
uint8_t r_17 = 183;
uint8_t g_18 = 199;
uint8_t b_19 = 111;
...
int16_t old_prevPX_13 = _instance->BreakoutGame_prevPX_var;
...
int16_t new_prevPX_13 = _instance->BreakoutGame_prevPX_var;
uint8_t prevPX_log_13[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x16, (((old_prevPX_13 >> 8) & 0xFF)), (((old_prevPX_13 >> 0) & 0xFF)), (((new_prevPX_13 >> 8) & 0xFF)), (((new_prevPX_13 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevPX_log_13, 7);
int16_t old_prevPY_12 = _instance->BreakoutGame_prevPY_var;
_instance->BreakoutGame_prevPY_var = _instance->BreakoutGame_pady_var / _instance->BreakoutGame_SCALE_var;
int16_t new_prevPY_12 = _instance->BreakoutGame_prevPY_var;
uint8_t prevPY_log_12[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x17, (((old_prevPY_12 >> 8) & 0xFF)), (((old_prevPY_12 >> 0) & 0xFF)), (((new_prevPY_12 >> 8) & 0xFF)), (((new_prevPY_12 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, prevPY_log_12, 7);
...
int16_t new_score_10 = _instance->BreakoutGame_score_var;
uint8_t score_log_10[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_10 >> 8) & 0xFF)), (((old_score_10 >> 0) & 0xFF)), (((new_score_10 >> 8) & 0xFF)), (((new_score_10 >> 0) & 0xFF))};
...
int16_t new_score_11 = _instance->BreakoutGame_score_var;
uint8_t score_log_11[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1B, (((old_score_11 >> 8) & 0xFF)), (((old_score_11 >> 0) & 0xFF)), (((new_score_11 >> 8) & 0xFF)), (((new_score_11 >> 0) & 0xFF))};
...
uint8_t old_level_26 = _instance->BreakoutGame_level_var;
_instance->BreakoutGame_level_var = _instance->BreakoutGame_level_var + 1;
uint8_t new_level_26 = _instance->BreakoutGame_level_var;
uint8_t level_log_26[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1D, old_level_26, new_level_26};
BreakoutGamePosix_send_log_log(_instance, level_log_26, 5);
...
int16_t old_padlen_4 = _instance->BreakoutGame_padlen_var;
_instance->BreakoutGame_padlen_var = _instance->BreakoutGame_padlen_var - (4 * _instance->BreakoutGame_SCALE_var);
int16_t new_padlen_4 = _instance->BreakoutGame_padlen_var;
uint8_t padlen_log_4[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x10, (((old_padlen_4 >> 8) & 0xFF)), (((old_padlen_4 >> 0) & 0xFF)), (((new_padlen_4 >> 8) & 0xFF)), (((new_padlen_4 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, padlen_log_4, 7);
...
uint8_t dy_log_22[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_22 >> 8) & 0xFF)), (((old_dy_22 >> 0) & 0xFF)), (((new_dy_22 >> 8) & 0xFF)), (((new_dy_22 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_22, 7);
...
uint8_t old_countdown_31 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
_instance->BreakoutGame_SC_LAUNCH_countdown_var = 3;
uint8_t new_countdown_31 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
uint8_t countdown_log_31[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_31, new_countdown_31};
BreakoutGamePosix_send_log_log(_instance, countdown_log_31, 5);
f_BreakoutGamePosix_drawScore(_instance);
f_BreakoutGamePosix_drawLives(_instance);
BreakoutGamePosix_send_display_update(_instance);
...
uint8_t new_lives_5 = _instance->BreakoutGame_lives_var;
uint8_t lives_log_5[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1C, old_lives_5, new_lives_5};
BreakoutGamePosix_send_log_log(_instance, lives_log_5, 5);
f_BreakoutGamePosix_eraseBall(_instance);
f_BreakoutGamePosix_erasePad(_instance);
f_BreakoutGamePosix_drawLives(_instance);
BreakoutGamePosix_send_display_update(_instance);
...
uint8_t nextLevelhandled_log_280[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x07, 0x02, 0x03, 0x05};
BreakoutGamePosix_send_log_log(_instance, nextLevelhandled_log_280, 6);
uint8_t id_225 = 0;
...
uint8_t lostBallhandled_log_281[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x07, 0x01, 0x03, 0x04};
BreakoutGamePosix_send_log_log(_instance, lostBallhandled_log_281, 6);
uint8_t id_223 = 0;
...
uint8_t timer_timeouthandled_log_275[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x02, 0x03, id};
...
uint8_t timer_timeouthandled_log_276[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x02, 0x00, id};
...
uint8_t old_countdown_32 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
_instance->BreakoutGame_SC_LAUNCH_countdown_var = _instance->BreakoutGame_SC_LAUNCH_countdown_var - 1;
uint8_t new_countdown_32 = _instance->BreakoutGame_SC_LAUNCH_countdown_var;
uint8_t countdown_log_32[5] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x1E, old_countdown_32, new_countdown_32};
BreakoutGamePosix_send_log_log(_instance, countdown_log_32, 5);
BreakoutGamePosix_send_display_update(_instance);
...
uint8_t timer_timeouthandled_log_272[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x03, 0x00, id};
BreakoutGamePosix_send_log_log(_instance, timer_timeouthandled_log_272, 7);
int16_t old_bx_15 = _instance->BreakoutGame_bx_var;
_instance->BreakoutGame_bx_var = _instance->BreakoutGame_bx_var + _instance->BreakoutGame_dx_var;
int16_t new_bx_15 = _instance->BreakoutGame_bx_var;
uint8_t bx_log_15[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_15 >> 8) & 0xFF)), (((old_bx_15 >> 0) & 0xFF)), (((new_bx_15 >> 8) & 0xFF)), (((new_bx_15 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_15, 7);
int16_t old_by_1 = _instance->BreakoutGame_by_var;
_instance->BreakoutGame_by_var = _instance->BreakoutGame_by_var + _instance->BreakoutGame_dy_var;
int16_t new_by_1 = _instance->BreakoutGame_by_var;
uint8_t by_log_1[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_1 >> 8) & 0xFF)), (((old_by_1 >> 0) & 0xFF)), (((new_by_1 >> 8) & 0xFF)), (((new_by_1 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_1, 7);
...
int16_t old_dx_28 = _instance->BreakoutGame_dx_var;
_instance->BreakoutGame_dx_var =  -_instance->BreakoutGame_dx_var;
int16_t new_dx_28 = _instance->BreakoutGame_dx_var;
uint8_t dx_log_28[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_28 >> 8) & 0xFF)), (((old_dx_28 >> 0) & 0xFF)), (((new_dx_28 >> 8) & 0xFF)), (((new_dx_28 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_28, 7);
...
uint8_t bx_log_16[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_16 >> 8) & 0xFF)), (((old_bx_16 >> 0) & 0xFF)), (((new_bx_16 >> 8) & 0xFF)), (((new_bx_16 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_16, 7);
f_BreakoutGamePosix_incrementScore(_instance,  -1);

} else {
if(_instance->BreakoutGame_bx_var > wr) {
int16_t old_dx_29 = _instance->BreakoutGame_dx_var;
_instance->BreakoutGame_dx_var =  -_instance->BreakoutGame_dx_var;
int16_t new_dx_29 = _instance->BreakoutGame_dx_var;
uint8_t dx_log_29[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_29 >> 8) & 0xFF)), (((old_dx_29 >> 0) & 0xFF)), (((new_dx_29 >> 8) & 0xFF)), (((new_dx_29 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_29, 7);
...
uint8_t bx_log_17[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0A, (((old_bx_17 >> 8) & 0xFF)), (((old_bx_17 >> 0) & 0xFF)), (((new_bx_17 >> 8) & 0xFF)), (((new_bx_17 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, bx_log_17, 7);
f_BreakoutGamePosix_incrementScore(_instance,  -1);
...
int16_t old_dy_19 = _instance->BreakoutGame_dy_var;
_instance->BreakoutGame_dy_var =  -_instance->BreakoutGame_dy_var;
int16_t new_dy_19 = _instance->BreakoutGame_dy_var;
uint8_t dy_log_19[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_19 >> 8) & 0xFF)), (((old_dy_19 >> 0) & 0xFF)), (((new_dy_19 >> 8) & 0xFF)), (((new_dy_19 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_19, 7);
int16_t old_by_2 = _instance->BreakoutGame_by_var;
_instance->BreakoutGame_by_var = 2 * wt - _instance->BreakoutGame_by_var;
int16_t new_by_2 = _instance->BreakoutGame_by_var;
uint8_t by_log_2[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_2 >> 8) & 0xFF)), (((old_by_2 >> 0) & 0xFF)), (((new_by_2 >> 8) & 0xFF)), (((new_by_2 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_2, 7);
f_BreakoutGamePosix_incrementScore(_instance,  -1);
...
uint8_t dy_log_20[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_20 >> 8) & 0xFF)), (((old_dy_20 >> 0) & 0xFF)), (((new_dy_20 >> 8) & 0xFF)), (((new_dy_20 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_20, 7);
int16_t old_by_3 = _instance->BreakoutGame_by_var;
...
int16_t new_by_3 = _instance->BreakoutGame_by_var;
uint8_t by_log_3[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0B, (((old_by_3 >> 8) & 0xFF)), (((old_by_3 >> 0) & 0xFF)), (((new_by_3 >> 8) & 0xFF)), (((new_by_3 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, by_log_3, 7);
int16_t old_dx_30 = _instance->BreakoutGame_dx_var;
...
int16_t new_dx_30 = _instance->BreakoutGame_dx_var;
uint8_t dx_log_30[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0C, (((old_dx_30 >> 8) & 0xFF)), (((old_dx_30 >> 0) & 0xFF)), (((new_dx_30 >> 8) & 0xFF)), (((new_dx_30 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dx_log_30, 7);
...
uint8_t dy_log_21[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0D, (((old_dy_21 >> 8) & 0xFF)), (((old_dy_21 >> 0) & 0xFF)), (((new_dy_21 >> 8) & 0xFF)), (((new_dy_21 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, dy_log_21, 7);
...
uint8_t timer_timeouthandled_log_273[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x04, 0x02, id};
...
uint8_t timer_timeouthandled_log_274[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x04, 0x06, id};
...
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LAUNCH_STATE;
uint8_t timer_timeouthandled_log_271[7] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x01, 0x16, 0x05, 0x02, id};
...
BreakoutGame_SC_OnExit(BREAKOUTGAME_SC_PLAY_STATE, _instance);
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_NEXTLEVEL_STATE;
uint8_t nextLevelhandled_log_278[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x05, 0x02, 0x03, 0x05};
BreakoutGamePosix_send_log_log(_instance, nextLevelhandled_log_278, 6);
uint8_t id_221 = 0;
...
BreakoutGame_SC_OnExit(BREAKOUTGAME_SC_PLAY_STATE, _instance);
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LOSTBALL_STATE;
uint8_t lostBallhandled_log_279[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x05, 0x01, 0x03, 0x04};
BreakoutGamePosix_send_log_log(_instance, lostBallhandled_log_279, 6);
uint8_t id_219 = 0;
...
_instance->BreakoutGame_SC_State = BREAKOUTGAME_SC_LAUNCH_STATE;
uint8_t displayReadyhandled_log_282[6] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x02, 0x10, 0x01, 0x02};
BreakoutGamePosix_send_log_log(_instance, displayReadyhandled_log_282, 6);
...
//Session list: 
if (1) {
uint8_t positionhandled_log_277[10] = {LOGTYPE_MESSAGE_HANDLED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x03, 0x12, 0x00, 0x00, (((x >> 8) & 0xFF)), (((x >> 0) & 0xFF)), (((y >> 8) & 0xFF)), (((y >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, positionhandled_log_277, 10);
int32_t center = (_instance->BreakoutGame_RIGHT_var - _instance->BreakoutGame_LEFT_var - _instance->BreakoutGame_padlen_var);
center = x * center;
center = center / 200;
int16_t old_padx_9 = _instance->BreakoutGame_padx_var;
...
int16_t new_padx_9 = _instance->BreakoutGame_padx_var;
uint8_t padx_log_9[7] = {LOGTYPE_PROPERTY_CHANGED, _instance->WithBinaryLog_DEBUG_BIN_ID_var, 0x0E, (((old_padx_9 >> 8) & 0xFF)), (((old_padx_9 >> 0) & 0xFF)), (((new_padx_9 >> 8) & 0xFF)), (((new_padx_9 >> 0) & 0xFF))};
BreakoutGamePosix_send_log_log(_instance, padx_log_9, 7);
BreakoutGame_SC_State_event_consumed = 1;
}
}
