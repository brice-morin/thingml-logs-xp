...
//New dispatcher for messages
void dispatch_property_changed(uint16_t sender, char * param_inst, char * param_prop_name, char * param_ty, char * param_old_value, char * param_new_value) {
if (sender == game_var.id_game) {
...
void sync_dispatch_BreakoutGamePosix_send_log_property_changed(struct BreakoutGamePosix_Instance *_instance, char * inst, char * prop_name, char * ty, char * old_value, char * new_value){
...
//New dispatcher for messages
void dispatch_function_called(uint16_t sender, char * param_inst, char * param_fn_name, char * param_ty, char * param_returns, char * param_params) {
if (sender == game_var.id_game) {
...
void sync_dispatch_BreakoutGamePosix_send_log_function_called(struct BreakoutGamePosix_Instance *_instance, char * inst, char * fn_name, char * ty, char * returns, char * params){
...
//New dispatcher for messages
void dispatch_message_sent(uint16_t sender, char * param_inst, char * param_port_name, char * param_msg_name, char * param_params) {
if (sender == game_var.id_game) {
...
void sync_dispatch_BreakoutGamePosix_send_log_message_sent(struct BreakoutGamePosix_Instance *_instance, char * inst, char * port_name, char * msg_name, char * params){
...
//New dispatcher for messages
void dispatch_message_lost(uint16_t sender, char * param_inst, char * param_port_name, char * param_msg_name, char * param_params) {
if (sender == game_var.id_game) {
...
void sync_dispatch_BreakoutGamePosix_send_log_message_lost(struct BreakoutGamePosix_Instance *_instance, char * inst, char * port_name, char * msg_name, char * params){
dispatch_message_lost(_instance->id_log, inst, port_name, msg_name, params);
}

//New dispatcher for messages
void dispatch_message_handled(uint16_t sender, char * param_inst, char * param_source, char * param_target, char * param_port_name, char * param_msg_name, char * param_params) {
if (sender == game_var.id_game) {
...
void sync_dispatch_BreakoutGamePosix_send_log_message_handled(struct BreakoutGamePosix_Instance *_instance, char * inst, char * source, char * target, char * port_name, char * msg_name, char * params){
...
register_BreakoutGamePosix_send_log_function_called_listener(&sync_dispatch_BreakoutGamePosix_send_log_function_called);
register_BreakoutGamePosix_send_log_message_sent_listener(&sync_dispatch_BreakoutGamePosix_send_log_message_sent);
register_BreakoutGamePosix_send_log_message_lost_listener(&sync_dispatch_BreakoutGamePosix_send_log_message_lost);
register_BreakoutGamePosix_send_log_property_changed_listener(&sync_dispatch_BreakoutGamePosix_send_log_property_changed);
register_BreakoutGamePosix_send_log_message_handled_listener(&sync_dispatch_BreakoutGamePosix_send_log_message_handled);
