...
BreakoutGameNodeJS.prototype.build = function(session) {
	...
	let BreakoutGame_SC_LAUNCH = new StateJS.State('LAUNCH', this._statemachine).entry(() => {
		...
		const old_countdown_21_var = '' + this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = 3;
		const new_countdown_21_var = '' + this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'countdown', 'UInt8', old_countdown_21_var, new_countdown_21_var));
		this.drawScore();
		this.drawLives();
	...
	let BreakoutGame_SC_LOSTBALL = new StateJS.State('LOSTBALL', this._statemachine).entry(() => {
		...
		const old_lives_15_var = '' + this.BreakoutGame_lives_var;
		this.BreakoutGame_lives_var = this.BreakoutGame_lives_var - 1;
		const new_lives_15_var = '' + this.BreakoutGame_lives_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'lives', 'UInt8', old_lives_15_var, new_lives_15_var));
		this.eraseBall();
		this.erasePad();
		this.drawLives();
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
	...
	let BreakoutGame_SC_NEXTLEVEL = new StateJS.State('NEXTLEVEL', this._statemachine).entry(() => {
		...
		const old_level_7_var = '' + this.BreakoutGame_level_var;
		this.BreakoutGame_level_var = this.BreakoutGame_level_var + 1;
		const new_level_7_var = '' + this.BreakoutGame_level_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'level', 'UInt8', old_level_7_var, new_level_7_var));
		this.drawLevel();
		this.eraseBall();
		this.erasePad();
		if((this.BreakoutGame_level_var % 2) === 0 && this.BreakoutGame_padlen_var > 5 * this.BreakoutGame_SCALE_var) {
		const old_padlen_26_var = '' + this.BreakoutGame_padlen_var;
		this.BreakoutGame_padlen_var = this.BreakoutGame_padlen_var - (4 * this.BreakoutGame_SCALE_var);
		const new_padlen_26_var = '' + this.BreakoutGame_padlen_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'padlen', 'Int16', old_padlen_26_var, new_padlen_26_var));
		
		}
		if((this.BreakoutGame_level_var % 2) === 1) {
		const old_dy_31_var = '' + this.BreakoutGame_dy_var;
		this.BreakoutGame_dy_var = Math.trunc((this.BreakoutGame_dy_var * 3) / 2);
		const new_dy_31_var = '' + this.BreakoutGame_dy_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_31_var, new_dy_31_var));
	...
	BreakoutGame_SC_LAUNCH.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const old_countdown_22_var = '' + this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.BreakoutGame_SC_LAUNCH_countdown_var = this.BreakoutGame_SC_LAUNCH_countdown_var - 1;
		const new_countdown_22_var = '' + this.BreakoutGame_SC_LAUNCH_countdown_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'countdown', 'UInt8', old_countdown_22_var, new_countdown_22_var));
		this.bus.emit('display', new Event.Update_DisplayMsgs(this.name, 'display'));
		this.bus.emit('log', new Event.Message_sent_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'display', 'update', ''));
	});
	BreakoutGame_SC_PLAY.on(Event.Timer_timeout).when((timer_timeout) => {
		...
		const old_bx_12_var = '' + this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = this.BreakoutGame_bx_var + this.BreakoutGame_dx_var;
		const new_bx_12_var = '' + this.BreakoutGame_bx_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_12_var, new_bx_12_var));
		...
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_1_var, new_dx_1_var));
		const old_bx_13_var = '' + this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = 2 * wl_var - this.BreakoutGame_bx_var;
		const new_bx_13_var = '' + this.BreakoutGame_bx_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_13_var, new_bx_13_var));
		...
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_2_var, new_dx_2_var));
		const old_bx_14_var = '' + this.BreakoutGame_bx_var;
		this.BreakoutGame_bx_var = 2 * wr_var - this.BreakoutGame_bx_var;
		const new_bx_14_var = '' + this.BreakoutGame_bx_var;
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_14_var, new_bx_14_var));
		this.incrementScore( -1);
		...
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_29_var, new_dy_29_var));
		...
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_3_var, new_dx_3_var));
		...
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dy', 'Int16', old_dy_30_var, new_dy_30_var));
	...
	this._statemachine.on(Event.Position).when((position) => {
		...
		this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'padx', 'Int16', old_padx_16_var, new_padx_16_var));
	});
}
...
BreakoutGameNodeJS.prototype.resetBall = function() {
	...
	const old_bx_11_var = '' + this.BreakoutGame_bx_var;
	this.BreakoutGame_bx_var = this.BreakoutGame_padx_var - Math.trunc(this.BreakoutGame_br_var / this.BreakoutGame_SCALE_var);
	const new_bx_11_var = '' + this.BreakoutGame_bx_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'bx', 'Int16', old_bx_11_var, new_bx_11_var));
	...
	const old_dx_0_var = '' + this.BreakoutGame_dx_var;
	this.BreakoutGame_dx_var = (this.BreakoutGame_padx_var + this.BreakoutGame_prevBX_var + this.BreakoutGame_prevBY_var) % 300 - 150;
	const new_dx_0_var = '' + this.BreakoutGame_dx_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'dx', 'Int16', old_dx_0_var, new_dx_0_var));
	if(this.BreakoutGame_dy_var > 0) {
	...
	const old_prevBX_8_var = '' + this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const new_prevBX_8_var = '' + this.BreakoutGame_prevBX_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevBX', 'Int16', old_prevBX_8_var, new_prevBX_8_var));
	const old_prevBY_4_var = '' + this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const new_prevBY_4_var = '' + this.BreakoutGame_prevBY_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevBY', 'Int16', old_prevBY_4_var, new_prevBY_4_var));
}
...
BreakoutGameNodeJS.prototype.eraseBall = function() {
	...
	const old_prevBX_9_var = '' + this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var =  -1;
	const new_prevBX_9_var = '' + this.BreakoutGame_prevBX_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevBX', 'Int16', old_prevBX_9_var, new_prevBX_9_var));
	const old_prevBY_5_var = '' + this.BreakoutGame_prevBY_var;
	this.BreakoutGame_prevBY_var =  -1;
	const new_prevBY_5_var = '' + this.BreakoutGame_prevBY_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevBY', 'Int16', old_prevBY_5_var, new_prevBY_5_var));
}
...
BreakoutGameNodeJS.prototype.drawBall = function() {
	...
	let bs_var = Math.trunc((this.BreakoutGame_br_var * 2) / this.BreakoutGame_SCALE_var);
	this.eraseBall();
	const old_prevBX_10_var = '' + this.BreakoutGame_prevBX_var;
	this.BreakoutGame_prevBX_var = Math.trunc((this.BreakoutGame_bx_var - this.BreakoutGame_br_var) / this.BreakoutGame_SCALE_var);
	const new_prevBX_10_var = '' + this.BreakoutGame_prevBX_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevBX', 'Int16', old_prevBX_10_var, new_prevBX_10_var));
	...
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevBY', 'Int16', old_prevBY_6_var, new_prevBY_6_var));
	const r_17_var = 183;
	const g_18_var = 199;
	const b_19_var = 111;
...
BreakoutGameNodeJS.prototype.drawPad = function() {
	...
	let ps_var = Math.trunc(this.BreakoutGame_padlen_var / this.BreakoutGame_SCALE_var);
	this.erasePad();
	const old_prevPX_23_var = '' + this.BreakoutGame_prevPX_var;
	...
	const new_prevPX_23_var = '' + this.BreakoutGame_prevPX_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevPX', 'Int16', old_prevPX_23_var, new_prevPX_23_var));
	...
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'prevPY', 'Int16', old_prevPY_32_var, new_prevPY_32_var));
...
BreakoutGameNodeJS.prototype.incrementScore = function(BreakoutGame_incrementScore_diff_var) {
	...
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'score', 'Int16', old_score_24_var, new_score_24_var));
	if(this.BreakoutGame_score_var < 0) {
	const old_score_25_var = '' + this.BreakoutGame_score_var;
	this.BreakoutGame_score_var = 0;
	const new_score_25_var = '' + this.BreakoutGame_score_var;
	this.bus.emit('log', new Event.Property_changed_LogMsgs(this.name, 'log', this.WithLog_DEBUG_ID_var, 'score', 'Int16', old_score_25_var, new_score_25_var));
