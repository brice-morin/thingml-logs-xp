...
func (state *ThingBreakoutGameGo) resetBall() {
	...
	var old_bx_8 string = "" + fmt.Sprintf("%d", int64(state.bx))
	state.bx = state.padx - state.br / state.SCALE
	var new_bx_8 string = "" + fmt.Sprintf("%d", int64(state.bx))
	...
	var old_by_22 string = "" + fmt.Sprintf("%d", int64(state.by))
	state.by = state.pady - state.br / state.SCALE
	var new_by_22 string = "" + fmt.Sprintf("%d", int64(state.by))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "by",
		Ty: "Int16",
	...
	var old_dx_26 string = "" + fmt.Sprintf("%d", int64(state.dx))
	state.dx = (state.padx + state.prevBX + state.prevBY) % 300 - 150
	var new_dx_26 string = "" + fmt.Sprintf("%d", int64(state.dx))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "dx",
		Ty: "Int16",
	...
	if state.dy > 0 {
		var old_dy_16 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.dy =  -(state.dy)
		var new_dy_16 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "dy",
			Ty: "Int16",
	...
	var old_prevBX_30 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.prevBX =  -(1)
	var new_prevBX_30 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBX",
		Ty: "Int16",
		Old_value: old_prevBX_30,
		New_value: new_prevBX_30,
	})
	var old_prevBY_3 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.prevBY =  -(1)
	var new_prevBY_3 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBY",
		Ty: "Int16",
		Old_value: old_prevBY_3,
		New_value: new_prevBY_3,
	})
}
func (state *ThingBreakoutGameGo) eraseBall() {
	...
	var old_prevBX_31 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.prevBX =  -(1)
	var new_prevBX_31 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBX",
		Ty: "Int16",
		Old_value: old_prevBX_31,
		New_value: new_prevBX_31,
	})
	var old_prevBY_4 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.prevBY =  -(1)
	var new_prevBY_4 string = "" + fmt.Sprintf("%d", int64(state.prevBY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBY",
		Ty: "Int16",
		Old_value: old_prevBY_4,
		New_value: new_prevBY_4,
	})
}
func (state *ThingBreakoutGameGo) drawBall() {
	...
	var bs int16 = (state.br * 2) / state.SCALE
	state.eraseBall()
	var old_prevBX_32 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.prevBX = (state.bx - state.br) / state.SCALE
	var new_prevBX_32 string = "" + fmt.Sprintf("%d", int64(state.prevBX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevBX",
		Ty: "Int16",
		Old_value: old_prevBX_32,
		New_value: new_prevBX_32,
	})
...
func (state *ThingBreakoutGameGo) drawPad() {
	...
	var ps int16 = state.padlen / state.SCALE
	state.erasePad()
	var old_prevPX_2 string = "" + fmt.Sprintf("%d", int64(state.prevPX))
	state.prevPX = (state.padx - (state.padlen / 2)) / state.SCALE
	var new_prevPX_2 string = "" + fmt.Sprintf("%d", int64(state.prevPX))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevPX",
		Ty: "Int16",
		Old_value: old_prevPX_2,
		New_value: new_prevPX_2,
	})
	var old_prevPY_13 string = "" + fmt.Sprintf("%d", int64(state.prevPY))
	state.prevPY = state.pady / state.SCALE
	var new_prevPY_13 string = "" + fmt.Sprintf("%d", int64(state.prevPY))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "prevPY",
		Ty: "Int16",
		Old_value: old_prevPY_13,
		New_value: new_prevPY_13,
	})
...
func (state *ThingBreakoutGameGo) incrementScore(diff int8) {
	...
	var old_score_6 string = "" + fmt.Sprintf("%d", int64(state.score))
	state.score = state.score + int16(diff)
	var new_score_6 string = "" + fmt.Sprintf("%d", int64(state.score))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "score",
		Ty: "Int16",
		Old_value: old_score_6,
		New_value: new_score_6,
	})
	if state.score < 0 {
		var old_score_7 string = "" + fmt.Sprintf("%d", int64(state.score))
		state.score = 0
		var new_score_7 string = "" + fmt.Sprintf("%d", int64(state.score))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "score",
			Ty: "Int16",
			Old_value: old_score_7,
			New_value: new_score_7,
		})
	}
	state.drawScore()
}
	...
	case FragmentControllerMsgsMsgposition:
		if e := typedMessage; port == BreakoutGameGo_BreakoutGame_controller {
			return true, true, state, func() {
				...
				center = center / 200
				var old_padx_15 string = "" + fmt.Sprintf("%d", int64(state.padx))
				state.padx = int16((int32(state.LEFT) + center + (int32(state.RIGHT) - int32(state.LEFT)) / 2))
				var new_padx_15 string = "" + fmt.Sprintf("%d", int64(state.padx))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "padx",
					Ty: "Int16",
					Old_value: old_padx_15,
					New_value: new_padx_15,
				})
			}
		}
...
func (state *FragmentBreakoutGameStateChartSCStateLAUNCH) OnEntry() {
	...
	var old_countdown_0 string = "" + fmt.Sprintf("%d", int64(state.countdown))
	state.countdown = 3
	var new_countdown_0 string = "" + fmt.Sprintf("%d", int64(state.countdown))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "countdown",
		Ty: "UInt8",
		Old_value: old_countdown_0,
		New_value: new_countdown_0,
	})
	state.drawScore()
	state.drawLives()
	...
	case FragmentTimerMsgsMsgtimer_timeout:
		if t := typedMessage; port == BreakoutGameGo_BreakoutGame_clock && (t.Id == 0 && state.countdown > 0) {
			return true, true, state, func() {
				...
				var old_countdown_1 string = "" + fmt.Sprintf("%d", int64(state.countdown))
				state.countdown = state.countdown - 1
				var new_countdown_1 string = "" + fmt.Sprintf("%d", int64(state.countdown))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "countdown",
					Ty: "UInt8",
					Old_value: old_countdown_1,
					New_value: new_countdown_1,
				})
				state.Send(BreakoutGameGo_BreakoutGame_display, FragmentDisplayMsgsMsgupdate{})
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgmessage_sent{
					Inst: state.DEBUG_ID,
	...
	case FragmentTimerMsgsMsgtimer_timeout:
		if t := typedMessage; port == BreakoutGameGo_BreakoutGame_clock && (t.Id == 0) {
			return true, true, state, func() {
				...
				var old_bx_9 string = "" + fmt.Sprintf("%d", int64(state.bx))
				state.bx = state.bx + state.dx
				var new_bx_9 string = "" + fmt.Sprintf("%d", int64(state.bx))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "bx",
					Ty: "Int16",
				...
				var old_by_23 string = "" + fmt.Sprintf("%d", int64(state.by))
				state.by = state.by + state.dy
				var new_by_23 string = "" + fmt.Sprintf("%d", int64(state.by))
				state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
					Inst: state.DEBUG_ID,
					Prop_name: "by",
					Ty: "Int16",
				...
				if state.bx < wl {
					var old_dx_27 string = "" + fmt.Sprintf("%d", int64(state.dx))
					state.dx =  -(state.dx)
					var new_dx_27 string = "" + fmt.Sprintf("%d", int64(state.dx))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "dx",
						Ty: "Int16",
					...
					var old_bx_10 string = "" + fmt.Sprintf("%d", int64(state.bx))
					state.bx = 2 * wl - state.bx
					var new_bx_10 string = "" + fmt.Sprintf("%d", int64(state.bx))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "bx",
						Ty: "Int16",
					...
					if state.bx > wr {
						var old_dx_28 string = "" + fmt.Sprintf("%d", int64(state.dx))
						state.dx =  -(state.dx)
						var new_dx_28 string = "" + fmt.Sprintf("%d", int64(state.dx))
						state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
							Inst: state.DEBUG_ID,
							Prop_name: "dx",
							Ty: "Int16",
						...
						var old_bx_11 string = "" + fmt.Sprintf("%d", int64(state.bx))
						state.bx = 2 * wr - state.bx
						var new_bx_11 string = "" + fmt.Sprintf("%d", int64(state.bx))
						state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
							Inst: state.DEBUG_ID,
							Prop_name: "bx",
							Ty: "Int16",
				...
				if state.by < wt {
					var old_dy_17 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.dy =  -(state.dy)
					var new_dy_17 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "dy",
						Ty: "Int16",
					...
					var old_by_24 string = "" + fmt.Sprintf("%d", int64(state.by))
					state.by = 2 * wt - state.by
					var new_by_24 string = "" + fmt.Sprintf("%d", int64(state.by))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "by",
						Ty: "Int16",
				...
				if state.dy > 0 {
					if state.by > state.pady - state.br && state.by < state.pady + state.br {
						if state.bx > state.padx - state.padlen / 2 && state.bx < state.padx + state.padlen / 2 {
							var old_dy_18 string = "" + fmt.Sprintf("%d", int64(state.dy))
							state.dy =  -(state.dy)
							var new_dy_18 string = "" + fmt.Sprintf("%d", int64(state.dy))
							state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
								Inst: state.DEBUG_ID,
								Prop_name: "dy",
								Ty: "Int16",
							...
							var old_by_25 string = "" + fmt.Sprintf("%d", int64(state.by))
							state.by = 2 * (state.pady - state.br) - state.by
							var new_by_25 string = "" + fmt.Sprintf("%d", int64(state.by))
							state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
								Inst: state.DEBUG_ID,
								Prop_name: "by",
								Ty: "Int16",
				...
				if collision {
					var old_dy_19 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.dy =  -(state.dy)
					var new_dy_19 string = "" + fmt.Sprintf("%d", int64(state.dy))
					state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
						Inst: state.DEBUG_ID,
						Prop_name: "dy",
						Ty: "Int16",
...
func (state *FragmentBreakoutGameStateChartSCStateLOSTBALL) OnEntry() {
	...
	var old_lives_21 string = "" + fmt.Sprintf("%d", int64(state.lives))
	state.lives = state.lives - 1
	var new_lives_21 string = "" + fmt.Sprintf("%d", int64(state.lives))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "lives",
		Ty: "UInt8",
		Old_value: old_lives_21,
		New_value: new_lives_21,
	})
	state.eraseBall()
	state.erasePad()
	state.drawLives()
...
func (state *FragmentBreakoutGameStateChartSCStateNEXTLEVEL) OnEntry() {
	...
	var old_level_12 string = "" + fmt.Sprintf("%d", int64(state.level))
	state.level = state.level + 1
	var new_level_12 string = "" + fmt.Sprintf("%d", int64(state.level))
	state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
		Inst: state.DEBUG_ID,
		Prop_name: "level",
		Ty: "UInt8",
		Old_value: old_level_12,
		New_value: new_level_12,
	})
	state.drawLevel()
	state.eraseBall()
	state.erasePad()
	if (state.level % 2) == 0 && state.padlen > 5 * state.SCALE {
		var old_padlen_14 string = "" + fmt.Sprintf("%d", int64(state.padlen))
		state.padlen = state.padlen - (4 * state.SCALE)
		var new_padlen_14 string = "" + fmt.Sprintf("%d", int64(state.padlen))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "padlen",
			Ty: "Int16",
			Old_value: old_padlen_14,
			New_value: new_padlen_14,
		})
	}
	if (state.level % 2) == 1 {
		var old_dy_20 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.dy = (state.dy * 3) / 2
		var new_dy_20 string = "" + fmt.Sprintf("%d", int64(state.dy))
		state.Send(BreakoutGameGo_WithLog_log, FragmentLogMsgsMsgproperty_changed{
			Inst: state.DEBUG_ID,
			Prop_name: "dy",
			Ty: "Int16",
