...
final int r_233_var = (int) (BreakoutGame_fgcolor_var[(int)(0)]);

final int g_234_var = (int) (BreakoutGame_fgcolor_var[(int)(1)]);

final int b_235_var = (int) (BreakoutGame_fgcolor_var[(int)(2)]);
...
final int r_242_var = (int) (BreakoutGame_fgcolor_var[(int)(0)]);

final int g_243_var = (int) (BreakoutGame_fgcolor_var[(int)(1)]);

final int b_244_var = (int) (BreakoutGame_fgcolor_var[(int)(2)]);
...
Transition h387377349 = new Transition();
h387377349.from(state_BreakoutGame_SC_INIT).to(state_BreakoutGame_SC_LAUNCH);
h387377349.event(displayReadyType);
h387377349.port(display_port);
h387377349.action((Event e)->{
...
initColors();
final int r_175_var = (int) (BreakoutGame_bgcolor_var[(int)(0)]);

final int g_176_var = (int) (BreakoutGame_bgcolor_var[(int)(1)]);

final int b_177_var = (int) (BreakoutGame_bgcolor_var[(int)(2)]);
...
final int r_184_var = (int) (BreakoutGame_fgcolor_var[(int)(0)]);

final int g_185_var = (int) (BreakoutGame_fgcolor_var[(int)(1)]);

final int b_186_var = (int) (BreakoutGame_fgcolor_var[(int)(2)]);
...
Handler h1385966234 = new Handler();
h1385966234.from(state_BreakoutGame_SC_LAUNCH);
h1385966234.event(timer_timeoutType);
h1385966234.guard((Event e)->{
...
h1385966234.port(clock_port);
h1385966234.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
...
Transition h380234542 = new Transition();
h380234542.from(state_BreakoutGame_SC_LAUNCH).to(state_BreakoutGame_SC_PLAY);
h380234542.event(timer_timeoutType);
h380234542.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_SC_LAUNCH_countdown_var() == 0;
});

h380234542.port(clock_port);
h380234542.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Handler h1648537147 = new Handler();
h1648537147.from(state_BreakoutGame_SC_PLAY);
h1648537147.event(timer_timeoutType);
h1648537147.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h1648537147.port(clock_port);
h1648537147.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Transition h379972461 = new Transition();
h379972461.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h379972461.event(lostBallType);
h379972461.port(game_port);
h379972461.action((Event e)->{
...
Transition h42338572 = new Transition();
h42338572.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h42338572.event(nextLevelType);
h42338572.port(game_port);
h42338572.action((Event e)->{
...
Transition h1135936028 = new Transition();
h1135936028.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_LOSTBALL);
h1135936028.event(lostBallType);
h1135936028.port(pro_game_port);
h1135936028.action((Event e)->{
...
Transition h430050226 = new Transition();
h430050226.from(state_BreakoutGame_SC_PLAY).to(state_BreakoutGame_SC_NEXTLEVEL);
h430050226.event(nextLevelType);
h430050226.port(pro_game_port);
h430050226.action((Event e)->{
...
Transition h380556447 = new Transition();
h380556447.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_LAUNCH);
h380556447.event(timer_timeoutType);
h380556447.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() > 0;
});

h380556447.port(clock_port);
h380556447.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Transition h992302041 = new Transition();
h992302041.from(state_BreakoutGame_SC_LOSTBALL).to(state_BreakoutGame_SC_GAMEOVER);
h992302041.event(timer_timeoutType);
h992302041.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0 && getBreakoutGame_lives_var() == 0;
});

h992302041.port(clock_port);
h992302041.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Transition h1775488894 = new Transition();
h1775488894.from(state_BreakoutGame_SC_NEXTLEVEL).to(state_BreakoutGame_SC_LAUNCH);
h1775488894.event(timer_timeoutType);
h1775488894.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return timer_timeout.id == 0;
});

h1775488894.port(clock_port);
h1775488894.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Handler h1338229093 = new Handler();
h1338229093.from(state_BreakoutGame_SC);
h1338229093.event(positionType);
h1338229093.port(controller_port);
h1338229093.action((Event e)->{
...
h1054913783.from(state_BreakoutGame_SC);
h1054913783.event(timer_timeoutType);
h1054913783.guard((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
return true;
});

h1054913783.port(clock_port);
h1054913783.action((Event e)->{
final Timer_timeoutMessageType.Timer_timeoutMessage timer_timeout = (Timer_timeoutMessageType.Timer_timeoutMessage) e;
final String params_var = (String) ("" + ("id=" + (timer_timeout.id + ",")));
...
Handler h690287064 = new Handler();
h690287064.from(state_BreakoutGame_SC);
h690287064.event(displayReadyType);
h690287064.guard((Event e)->{
return true;
});

h690287064.port(display_port);
h690287064.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("display"), (String) ("displayReady"), (String) (""));
});

Handler h1815501246 = new Handler();
h1815501246.from(state_BreakoutGame_SC);
h1815501246.event(lostBallType);
h1815501246.guard((Event e)->{
return true;
});

h1815501246.port(game_port);
h1815501246.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("game"), (String) ("lostBall"), (String) (""));
});

Handler h685407505 = new Handler();
h685407505.from(state_BreakoutGame_SC);
h685407505.event(nextLevelType);
h685407505.guard((Event e)->{
return true;
});

h685407505.port(game_port);
h685407505.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("game"), (String) ("nextLevel"), (String) (""));
});

Handler h1517105378 = new Handler();
h1517105378.from(state_BreakoutGame_SC);
h1517105378.event(lostBallType);
h1517105378.guard((Event e)->{
return true;
});

h1517105378.port(pro_game_port);
h1517105378.action((Event e)->{
sendMessage_lost_via_log((String) (getWithLog_DEBUG_ID_var()), (String) ("pro_game"), (String) ("lostBall"), (String) (""));
});

Handler h1977493952 = new Handler();
h1977493952.from(state_BreakoutGame_SC);
h1977493952.event(nextLevelType);
h1977493952.guard((Event e)->{
return true;
});

h1977493952.port(pro_game_port);
h1977493952.action((Event e)->{
