...
for LANGUAGE in ${LANGUAGES[@]}; do
  ...
  _docker run --rm -v $BASEDIR:/thingml-div thingml-div thingml -c $COMPILER -s /thingml-div/src/main/thingml/$LANGUAGE.thingml -o /thingml-div/target/code/$LANGUAGE
